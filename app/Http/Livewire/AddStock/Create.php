...
// dd($variations->first()->id===$product->product_dimensions->variation_id);
          $new_item = [
            ...
            'sub_total' => 0,
            'dollar_sub_total' => 0,
            'size' => isset($variations->first()->id)?(!empty($product->product_dimensions->size && $variations->first()->id===$product->product_dimensions->variation_id) ? $product->product_dimensions->size :0):0,
            'total_size' => isset($variations->first()->id)?(!empty($product->product_dimensions->size && $variations->first()->id==$product->product_dimensions->variation_id) ? $product->product_dimensions->size * 1 :0):0,
            'weight' => isset($variations->first()->id)?(!empty($product->product_dimensions->weight && $variations->first()->id==$product->product_dimensions->variation_id) ? $product->product_dimensions->weight :0):0,
            'total_weight' => isset($variations->first()->id)?(!empty($product->product_dimensions->weight && $variations->first()->id==$product->product_dimensions->variation_id) ? $product->product_dimensions->weight * 1 :0):0,
            'dollar_cost' => 0,
            'cost' => 0,
            'dollar_total_cost' => 0,
            'total_cost' => 0,
