...
{
    public $selectedItem,$transaction,$users = [],$exchange_rate, $stocks, $supplier_id,
        $product_name, $product_sku, $product_symbol, $created_by, $po_no, $from, $to;
...
//        $this->stocks =  StockTransaction::where('type','add_stock')->orderBy('created_at', 'desc')->get();
        ...
        return view('livewire.add-stock.index')->with(compact('suppliers','users'));
    }
