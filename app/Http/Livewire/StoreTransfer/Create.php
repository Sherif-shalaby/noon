...
namespace App\Http\Livewire\StoreTransfer;
...
{
    public $store_id, $receiver_store_id, $sender_store_id, $stores, $products , $items = [], $searchProduct,
...
//            dd($e);
        ...
        return redirect('/store_transfer/create');
    }
    ...
    public function add_product($id)
    {
        ...
        if ($quantity_available < 1) {
            ...
            if (count($newArr) > 0) {
                ...
                $purchase_price = !empty($current_stock->used_currency != 2 ) ? number_format($current_stock->purchase_price, num_of_digital_numbers()) : 0;
                $dollar_purchase_price = !empty($current_stock->used_currency == 2) ? number_format($current_stock->dollar_purchase_price, num_of_digital_numbers()) : 0;
