        ...
        if ($quantity_available < 1) {
            ...
            if (count($newArr) > 0 && $variationId == null) {
                ...
                $new_item = [
                    ...
                    'dollar_sub_total' => $price > 0 ?  round((float)1 * $this->num_uf($price/ $exchange_rate),3) : (float) 1 * $this->num_uf($dollar_price),
                    ...
                    'dollar_price' => $price > 0 ? round($this->num_uf($price / $exchange_rate),3) : $this->num_uf($dollar_price) ,
