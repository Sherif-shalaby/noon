...
//                foreach ($this->rows as $rowPrice){
//                    foreach ($rowPrice['prices'] as $index => $price) {
//                        if ($price['customer_type_id'] == $customer_type) {
//                            unset($this->rows[$key]['prices'][$index]);
//                        }
//                    }
//                    $rowPrice['prices'] = array_values($rowPrice['prices']);
//                }
