...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            ...
            "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            ["id" => "134", "country" => "Bangladesh", "currency" => "Taka", "code" => "BDT", "symbol" => "৳", "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            ["id" => "135", "country" => "Libyan", "currency" => "Libyan dinar", "code" => "LYD", "symbol" => "LD", "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            ["id" => "136", "country" => "Algerie", "currency" => "Algerian dinar", "code" => "DZD", "symbol" => "د.ج", "thousand_seperator" => " ", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "137", "country" => "United Arab Emirates", "currency" => "United Arab Emirates dirham", "code" => "AED", "symbol" => "د.إ", "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "138", "country" => "Uganda", "currency" => "Uganda shillings", "code" => "UGX", "symbol" => "USh", "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "139", "country" => "Tanzania", "currency" => "Tanzanian shilling", "code" => "TZS", "symbol" => "TSh", "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "140", "country" => "Angola", "currency" => "Kwanza", "code" => "AOA", "symbol" => "Kz", "thousand_seperator" => ",", "decimal_seperator" => ".", "created_at" => null , "updated_at" => null ]
