...
function launchImageCropTool(img) {
    ...
    var croppieOptions = {
        viewport: {
            ...
            type: "portrait", // or 'landscape' based on your preference
        },
        boundary: {
            width: 300, // Set a boundary larger than A4 size if needed
            height: 400, // Set a boundary larger than A4 size if needed
        },
    ...
    croppieImageSubmitBtn.addEventListener("click", () => {
        croppie
            .result({
                type: "canvas",
                size: {
                    width: 210, // A4 width in pixels
                    height: 297, // A4 height in pixels
                },
