    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">@lang('lang.daily_purchase_report')</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/')}}">@lang('lang.dashboard')</a></li>
                        <li class="breadcrumb-item"><a href="{{route('initial-balance.create')}}">@lang('lang.reports')</a></li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('lang.daily_purchase_report')</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="col-md-12">
                    <table class="table table-bordered"
                        ...
                        <tr>
                            <th>
                                <a style="color: #6e81dc" href="{{url('reports/daily_purchase_report?year='.$prev_year.'&month='.$prev_month)}}"><i
                                        class="fa fa-arrow-left"></i> @lang('lang.previous')
                                </a>
                            </th>
                            <th colspan="5" class="text-center">
                                {{date("F", strtotime($year.'-'.$month.'-01')).' ' .$year}}</th>
                            <th>
                                <a style="color: #6e81dc" href="{{url('reports/daily_purchase_report?year='.$next_year.'&month='.$next_month)}}">
                                    @lang('lang.next')
