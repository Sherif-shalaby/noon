        ...
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="font-weight-bold text-decoration-none text-dark font-18"
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h6 class="card-title">@lang('lang.reports')</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <ul>
                                <li>
                                    <a class="font-weight-bold text-decoration-none text-dark font-18"
