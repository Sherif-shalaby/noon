                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons"
                                    class="table table-striped table-hover table-bordered  table-button-wrapper @if (app()->isLocale('ar')) dir-rtl @endif">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach ($wages as $wage)
                                            ...
                                            <tr>
                                                ...
                                                <td title="@lang('lang.payment_status')">{{ $wage->wage_transaction->payment_status }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
