<div class="row">
    ...
    <button type="button" id="dollar_section" class="btn btn-primary ml-4" style="margin-top: 15px;"
        wire:click="ShowDollarCol"> <i class="fa fa-eye-slash" aria-hidden="true"></i> </button>
</div>

<div class="modal fade" id="select_products_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    wire:ignore aria-hidden="true" style="width: 100%;">
    <div class="modal-dialog modal-lg" role="document" id="select_products_modal">
        <div class="modal-content">
                    ...
                    <table id="product_selection_table" class="table" style="width: auto">
                        ...
                        <tbody>
                            @foreach ($variations as $index => $variation)
                                <tr>
                                    <td>
                                        <input type="checkbox" name="product_selected" class="product_selected"
                                            value="{{ $variation->id }}" wire:model="selectedProducts" />
                                    </td>
                                    <td><img src="{{ !empty($variation->product->image) ? '/uploads/products/' . $variation->product->image : '/uploads/' . $settings['logo'] }}"
                                            style="width: 50px; height: 50px;" alt="{{ $variation->product->name }}">
                                    </td>
                                    ...
                                    <td>{{ !empty($variation->product->brand) ? $variation->product->brand->name : '' }}
                                    </td>
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('products.edit', $variation->id) }}"
                                                        class="btn" target="_blank"><i
                                                            class="dripicons-document-edit"></i> @lang('lang.update')</a>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="add-selected-btn"
                    wire:click="fetchSelectedProducts()">@lang('lang.add')</button>
