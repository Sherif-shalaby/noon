<tr>
    ...
    {{-- +++++++++++++++++++++ column 7 : سعر الشراء +++++++++++++++++++++ --}}
    {{-- <td>
        <input type="text" class="form-control" value="00000" wire:model="items.{{ $index }}.purchase_price"
    ...
    <td class="text-center dollar-cell showHideDollarCells" style="font-size: 14px;font-weight: 500;">
        @if (isset($product['quantity']) && isset($product['dollar_selling_price']))
