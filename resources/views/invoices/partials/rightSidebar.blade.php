<div class="p-0">
    <div class="card-app">
        <div class=" d-flex flex-row-reverse justify-content-between body-card-app pt-2" style="background-color: #eee">
            <div class="col-md-1 p-0" style="display: flex;
            ...
            <div class="d-flex justify-content-between align-items-center flex-column flex-wrap col-md-11 p-0">
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <div class="col-md-2 p-0">
                        <a href="{{ route('recent_transactions') }}" target="_blank"
                            style="width: 100%;font-size: 12px;font-weight: 600;background-color: #ffc107;"
                ...
                <div class="d-flex justify-content-end align-items-center w-100">
                    <div class="col-md-2 p-0 {{ ($dollar_final_total != 0 && $total_dollar != 0 && $back_to_dollar == 0) ||
                        ...
                        <div class="custom-control custom-switch">
                            ...
                            <label class="custom-control-label mb-0" for="customSwitch1"
                                wire:click="ChangeBillToDinar()" {{ $back_to_dollar==1 ? 'checked' : '' }}>{{
                                __('lang.change_bill_to') }}
                                {{ $back_to_dollar == 0 ? __('lang.dinar_c') : __('lang.dollar_c') }}</label>
                        </div>
                        {{-- <button type="button" class="btn btn-success" wire:click="ChangeBillToDinar()">{{
                            __('lang.change_bill_to_dinar') }}</button> --}}
                    </div>

                    <div class="col-md-2 ">
                        <button class="btn btn-danger {{ $add_to_balance == '0' ? 'd-none' : '' }}"
                            style="width: 100%;font-size: 12px;font-weight: 600;" wire:click="addToBalance()">{{
                            __('lang.add_to_balance') }}</button>
                    </div>
                    <div class="col-md-2 p-0">
                        {!! Form::label('customer_name', __('lang.customer_name'), [
                        'class' => app()->isLocale('ar') ? 'text-end text-primary mb-0' : 'text-start text-primary
                        mb-0',
        ...
        <div class="body-card-app pt-2 pb-0 d-flex flex-wrap justify-content-end align-items-center position-relative">
            ...
            <div class="col-md-8 p-0 d-flex justify-content-end">
                ...
                @endif
                <div
                    class="col-md-2 dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">
