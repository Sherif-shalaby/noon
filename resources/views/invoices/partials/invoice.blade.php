...
<section>
    ...
    <div class="invoice">
        <table class="content_table">
            ...
            <th>@lang('lang.price_of_piece')</th>
            <th>@lang('lang.quantity')</th>
            <th>@lang('lang.fill')</th>
            <th>@lang('lang.carton')</th>
...
{{--                    {{dd($line)}}--}}
                    ...
                    <td></td>
                    <td></td>
                    <td>{{$line->product->unit->base_unit_multiplier}}</td>
...
{{--<div style="max-width:90%;margin:0 auto; padding: 0px 15px; color: black !important;">--}}
...
{{--        </div>--}}
{{--        <div>--}}
{{--            <table class="table" style="margin: 0 auto; text-align: center !important">--}}
{{--                <thead>--}}
{{--                <tr>--}}
...
{{--                    @endif--}}
{{--                    <th style="width: 30%; padding: 0 50px !important;">@lang('lang.notes')</th>--}}
{{--                    <th style="width: 30%; padding: 0 50px !important;">@lang('lang.description')</th>--}}
