                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                --}}
                                                <th class="col12 sum">@lang('lang.grand_total') @lang('lang.dinar_c')
                                                </th>
                                                <th class="col13 sum">@lang('lang.paid') @lang('lang.dinar_c')</th>
                                                <th class="col14 sum">@lang('lang.due_sale_list') @lang('lang.dinar_c')
                                                </th>

                                                <th class="col12 dollar-cell showHideDollarCells sum">
                                                    @lang('lang.grand_total')
                                                    @lang('lang.dollar_c')</th>
                                                <th class="col13 dollar-cell showHideDollarCells sum">@lang('lang.paid')
                                                    @lang('lang.dollar_c')</th>
                                                <th class="col14 dollar-cell showHideDollarCells sum">
                                                    @lang('lang.due_sale_list')
                                                    @lang('lang.dollar_c')</th>
                                        ...
                                        <tbody>
                                            ...
                                            $toggle_dollar == 1 &&
                                            ($line->dollar_final_total != 0 ||
                                            $line->transaction_payments->sum('dollar_amount') != 0))
                                            @continue
                                            @else
                                            <tr>
                                                <td class="col1">
                                                ...
                                                <td class="col14 dollar-cell showHideDollarCells">
                                                    <span
                                                        class="custom-tooltip d-flex justify-content-center align-items-center"
                                                        style="font-size: 12px;font-weight: 600"
                                                        data-tooltip="@lang('lang.grand_total') @lang('lang.dollar_c')">
                                                        {{ number_format($line->dollar_final_total,
                                                        num_of_digital_numbers()) }}

                                                    </span>
                                                </td>
                                                <td class="col15 dollar-cell showHideDollarCells">
                                                    <span
                                                        class="custom-tooltip d-flex justify-content-center align-items-center"
                                                        style="font-size: 12px;font-weight: 600"
                                                ...
                                                <td class="col16 dollar-cell showHideDollarCells">
                                                    <span
                                                        class="custom-tooltip d-flex justify-content-center align-items-center"
                                                        style="font-size: 12px;font-weight: 600"
                                                ...
                                                <td class="col23">
                                                    <span
                                                        ...
                                                        @foreach ($line->transaction_payments as $payment)
                                                        {{ $payment->received_currency_relation->payment_note ?? ''
                                                        }}<br>
                                                        @endforeach
                                                    </span>
                                                </td>
