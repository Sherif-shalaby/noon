    ...
    <div class="collapse navbar-collapse d-flex  justify-content-between" id="navbar-menu">
        <ul style="width: 100%"
                ...
                <li class="scroll">
                    <a href="{{ route('products.create') }}"
                        ...
                        <img src="{{ asset('images/topbar/dairy-products.png') }}" class="img-fluid pl-1"
                            alt="widgets"><span>{{ __('lang.products') }}</span></a>
                </li>
            @endif
            {{-- @endcan --}}
            {{-- ###################### Cashier : المبيعات ###################### --}}
            ...
            @if (!empty($module_settings['cashier_module']))
                <li class="scroll">
                    <a href="{{ route('pos.index') }}"
                        class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"><img
            ...
            @if (!empty($module_settings['return_module']))
                <li class="dropdown">
                    <a href="javaScript:void();"
                        ...
                        data-toggle="dropdown"><img src="{{ asset('images/topbar/return.png') }}"
                            class="img-fluid pl-1" alt="pages"><span>{{ __('lang.returns') }}</span></a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown">
                    <a href=""
                        class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"><img
                            ...
                            alt="widgets"><span>{{ __('lang.employees') }}</span></a>
                    <ul class="dropdown-menu">
            ...
            @if (!empty($module_settings['supplier_module']))
                <li class="scroll"><a href="{{ route('suppliers.create') }}"
                        class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif "><img
            ...
            @if (!empty($module_settings['settings_module']))
                <li class="dropdown menu-item-has-mega-menu">
                    <a href="javaScript:void();"
                        class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif dropdown-toggle"
                        data-toggle="dropdown"><img src="{{ asset('images/topbar/settings.png') }}"
                            class="img-fluid pl-1" alt="basic"><span>{{ __('lang.settings') }}</span></a>
