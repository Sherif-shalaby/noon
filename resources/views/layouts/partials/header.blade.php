                ...
                <li class="dropdown menu-item-has-mega-menu">
                    ...
                    <div class="mega-menu dropdown-menu">
                        <ul class="mega-menu-row" role="menu">
                            <li class="mega-menu-col col-md-3">
                                <ul class="sub-menu">
                                    <li><a href="basic-ui-kits-alerts.html"><i class="mdi mdi-circle"></i>Alerts</a></li>
                                    <li><a href="basic-ui-kits-badges.html"><i class="mdi mdi-circle"></i>Badges</a></li>
                                    <li><a href="basic-ui-kits-buttons.html"><i class="mdi mdi-circle"></i>Buttons</a></li>
                                    <li><a href="basic-ui-kits-cards.html"><i class="mdi mdi-circle"></i>Cards</a></li>
                                    <li><a href="basic-ui-kits-carousel.html"><i class="mdi mdi-circle"></i>Carousel</a></li>
                                </ul>
                            </li>
                            <li class="mega-menu-col col-md-3">
                                <ul class="sub-menu">
                            ...
                            <li class="mega-menu-col col-md-3">
                                <ul class="sub-menu">
                                    <li><a href="basic-ui-kits-media.html"><i class="mdi mdi-circle"></i>Media</a></li>
                                    <li><a href="basic-ui-kits-modals.html"><i class="mdi mdi-circle"></i>Modals</a></li>
                                    <li><a href="basic-ui-kits-paginations.html"><i class="mdi mdi-circle"></i>Paginations</a></li>
                                    <li><a href="basic-ui-kits-popovers.html"><i class="mdi mdi-circle"></i>Popovers</a></li>
                                    <li><a href="basic-ui-kits-progressbars.html"><i class="mdi mdi-circle"></i>Progress Bars</a></li>
                                </ul>
                            </li>
                            <li class="mega-menu-col col-md-3">
                                <ul class="sub-menu">
                                    <li><a href="basic-ui-kits-spinners.html"><i class="mdi mdi-circle"></i>Spinners</a></li>
                                    <li><a href="basic-ui-kits-tabs.html"><i class="mdi mdi-circle"></i>Tabs</a></li>   
                                    <li><a href="basic-ui-kits-toasts.html"><i class="mdi mdi-circle"></i>Toasts</a></li>     
                                    <li><a href="basic-ui-kits-tooltips.html"><i class="mdi mdi-circle"></i>Tooltips</a></li>
                                    <li><a href="basic-ui-kits-typography.html"><i class="mdi mdi-circle"></i>Typography</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
