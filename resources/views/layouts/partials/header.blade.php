                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="horizontal-menu">
                        ...
                        @if (!empty($module_settings['dashboard']))
                            <li class="scroll">
                                <a target="_blank" href="{{ url('/') }}"><img
                                        src="{{ asset('images/topbar/dashboard.png') }}" class="img-fluid"
                                        alt="dashboard">
                        ...
                        @if (!empty($module_settings['product_module']))
                            <li class="scroll"><a target="_blank" href="{{ route('products.create') }}"><img
                                        src="{{ asset('images/topbar/dairy-products.png') }}" class="img-fluid"
                                        alt="widgets"><span>{{ __('lang.products') }}</span></a></li>
                        @endif
                        {{-- @endcan --}}
                        {{-- ###################### Cashier : المبيعات ###################### --}}
                        {{-- @can('cashier_module') --}}
                        @if (!empty($module_settings['cashier_module']))
                            <li class="scroll">
                                <a target="_blank" href="{{ route('pos.index') }}"><img
                                        src="{{ asset('images/topbar/cashier-machine.png') }}" class="img-fluid"
                                        alt="apps"><span>{{ __('lang.sells') }}</span></a>
                            </li>
                        @endif
                        {{-- @endcan --}}
                        ...
                        <li class="scroll">
                            <a target="_blank" href="{{ route('cash.index') }}">
                                <img src="{{ asset('images/topbar/cashier-machine.png') }}" class="img-fluid"
                                    alt="apps">
                        ...
                        <li>
                            <a target="_blank" href="{{ route('stocks.create') }}"><img
                                    src="{{ asset('images/topbar/warehouse.png') }}" class="img-fluid"
                                    alt="components"><span>{{ __('lang.stock') }}</span></a>
                        </li>
                        @endif
                        @if (!empty($module_settings['stock_module']))
                            <li>
                                <a target="_blank" href="{{ route('new-initial-balance.create') }}"><img
                                        src="{{ asset('images/topbar/warehouse.png') }}" class="img-fluid"
                                        alt="components"><span>{{ __('lang.initial_balance') }}</span></a>
                            </li>
                        @endif
                        {{-- @endcan --}}
                        ...
                        <li class="dropdown">
                            <a target="_blank" href="#">
                                <img src="{{ asset('images/topbar/warehouse.png') }}" class="img-fluid"
                                    alt="components">
                                <span>{{ __('lang.purchase_order') }}</span>
                            </a>
                            <ul class="dropdown-menu">
                                {{-- ########### purchase_order : اوامر الشراء########### --}}
                                <li><a target="_blank" href="{{ route('purchase_order.index') }}"><i
                                            class="mdi mdi-circle"></i>@lang('lang.show_purchase_order')</a></li>
                                {{-- ########### required_products : المواد المطلوبة ########### --}}
                                <li><a target="_blank" href="{{ route('required-products.index') }}"><i
                        ...
                        @if (!empty($module_settings['return_module']))
                            <li class="dropdown">
                                <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img
                                        src="{{ asset('images/topbar/return.png') }}" class="img-fluid"
                                        alt="pages"><span>{{ __('lang.returns') }}</span></a>
                                <ul class="dropdown-menu">
                                    <li><a target="_blank" href="{{ route('sell_return.index') }}"><i
                        ...
                        @if (!empty($module_settings['return_module']))
                            <li class="dropdown">
                                <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="{{ asset('images/topbar/return.png') }}" class="img-fluid"
                                        alt="pages">
                        ...
                        @if (!empty($module_settings['employee_module']))
                            <li class="dropdown">
                                <a href=""><img src="{{ asset('images/topbar/employee.png') }}"
                                        class="img-fluid" alt="widgets"><span>{{ __('lang.employees') }}</span></a>
                                <ul class="dropdown-menu">
                                    <li><a target="_blank" href="{{ route('jobs.index') }}"><i
                                                class="mdi mdi-circle"></i>@lang('lang.jobs')</a></li>
                                    <li><a target="_blank" href="{{ route('employees.create') }}"><i
                                                class="mdi mdi-circle"></i>@lang('lang.employees')</a></li>
                                    <li><a target="_blank" href="{{ route('wages.create') }}"><i
                                                class="mdi mdi-circle"></i>@lang('lang.wages')</a></li>
                                    {{-- ########### Attendance : الحضور و الانصراف ########### --}}
                                    <li><a target="_blank" href="{{ route('attendance.index') }}"><i
                        ...
                        @if (!empty($module_settings['customer_module']))
                            <li class="dropdown">
                                <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img
                                        src="{{ asset('images/topbar/customer-feedback.png') }}" class="img-fluid"
                                        alt="layouts"><span>{{ __('lang.customers') }}</span></a>
                                <ul class="dropdown-menu">
                                    <li><a target="_blank" href="{{ route('customers.create') }}"><i
                                                class="mdi mdi-circle"></i>{{ __('lang.customers') }}</a></li>
                                    <li><a target="_blank" href="{{ route('customertypes.index') }}"><i
                        ...
                        @if (!empty($module_settings['customer_module']))
                            <li>
                                <a target="_blank" href="{{ route('customer_price_offer.create') }}">
                                    <img src="{{ asset('images/topbar/customer-feedback.png') }}" class="img-fluid"
                                        alt="layouts">
                        ...
                        @if (!empty($module_settings['supplier_module']))
                            <li class="scroll"><a target="_blank" href="{{ route('suppliers.create') }}"><img
                                        src="{{ asset('images/topbar/inventory.png') }}" class="img-fluid"
                                        alt="widgets"><span>{{ __('lang.suppliers') }}</span></a></li>
                        @endif

                        <li class="dropdown">
                            <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img
                                    src="{{ asset('images/topbar/customer-feedback.png') }}" class="img-fluid"
                                    alt="layouts"><span>{{ __('lang.delivery') }}</span></a>
                            <ul class="dropdown-menu">
                                <li><a target="_blank" href="{{ route('delivery.index') }}"><i
                                            class="mdi mdi-circle"></i>{{ __('lang.index') }}</a></li>
                                <li><a target="_blank" href="{{ route('delivery_plan.plansList') }}"><i
                                            class="mdi mdi-circle"></i>{{ __('lang.plans') }}</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                {{-- ########### purchase_order : اوامر الشراء########### --}}
                                <li><a target="_blank" href="{{ route('sell-car.index') }}"><i
                                            class="mdi mdi-circle"></i>@lang('lang.sell_car')</a></li>
                                {{-- ########### required_products : المواد المطلوبة ########### --}}
                                <li><a target="_blank" href="{{ route('delivery.index') }}"><i
                                            class="mdi mdi-circle"></i>@lang('lang.plans')</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a target="_blank" href="{{ route('representatives.index') }}"><i
                                            class="mdi mdi-circle"></i>{{ __('lang.representatives_requests') }}</a>
                                </li>
                                <li><a target="_blank" href="{{ route('rep_plan.index') }}"><i
                                            class="mdi mdi-circle"></i>{{ __('lang.plans') }}</a></li>
                        ...
                        @if (!empty($module_settings['settings_module']))
                            <li class="dropdown menu-item-has-mega-menu">
                                <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img
                                        src="{{ asset('images/topbar/settings.png') }}" class="img-fluid"
                                        alt="basic"><span>{{ __('lang.settings') }}</span></a>
                        ...
                        @if (!empty($module_settings['reports_module']))
                            <li class="dropdown">
                                <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="{{ asset('images/topbar/report.png') }}" class="img-fluid"
                                        alt="advanced">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    {{-- +++++++++++ productTransacrionReport Report +++++++++++ --}}
                                    <li>
                                        <a target="_blank" href="{{ route('ProductReport.index') }}">
                                            {{-- <i class="mdi mdi-circle"></i>{{__('lang.supplier_report')}} --}}
                                            <i class="mdi mdi-circle"></i> تقرير حركة صنف
                                        </a>
                                    </li>
                                    {{-- +++++++++++ productTransacrionReport Report +++++++++++ --}}
                        ...
                        <li class="dropdown">
                            <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img
                                    src="{{ asset('images/topbar/customer-feedback.png') }}" class="img-fluid"
                                    alt="layouts"><span>{{ __('lang.process_invoices') }}</span></a>
                            <ul class="dropdown-menu">
                                <li><a target="_blank" href="{{ route('process-invoice.index') }}"><i
