...
<div class="d-flex justify-content-start align-items-center @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif @if ($index % 2 == 0) bg-white @else bg-dark-gray @endif"
    ...
    <div class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
        ...
        <div class=" animate__animated  animate__bounceInLeft d-flex flex-column store_drop_down  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <div class="input-wrapper" style="width: 100%!important">
                <select name="items.{{ $index }}.variation_id" class="form-select "
                    wire:model="items.{{ $index }}.variation_id" wire:input="getVariationData({{ $index }})">
                    <option value="" selected>{{ __('lang.please_select') }}</option>
            ...
            <div class="accordion-item" style="border: none">
                <h2 class="accordion-header">
                    <button class="accordion-button p-1 btn btn-primary collapsed" style="color: white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse{{ $index }}unit-details"
        ...
        <div class="animate__animated   animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
            ...
            <label for="quantity" class="mb-0 @if (app()->isLocale('ar')) d-block text-end mx-2 @else  mx-2 @endif"
        ...
        <div class=" animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            style="width: 85px;min-height: 60px">
        ...
        <div id="panelsStayOpen-collapse{{ $index }}unit-details"
            ...
            <div class="accordion-body p-0 d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                ...
                <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
                    ...
                    <span class="form-control quantity initial-balance-input width-full">{{ @number_format($unitValue,
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <input type="text" class="form-control initial-balance-input width-full"
                wire:model="items.{{ $index }}.purchase_price" wire:change="convertPurchasePrice({{ $index }})"
                required>
            <span
                class="dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} text-center d-flex justify-content-center py-1 align-items-center initial-balance-input width-full m-0"
                style='font-weight:700;font-size:14px;color:#333;'>{{ @number_format($product['dollar_purchase_price'],
                num_of_digital_numbers()) ?? 0 }}$</span>
        ...
        !empty($product['dollar_purchase_price'])))
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column align-items-center mr-1"
            ...
            <label for="sub_total" class="mb-0 @if (app()->isLocale('ar')) d-block text-end  mx-2 @else mx-2 @endif"
            ...
            <b style='font-weight:700;font-size:14px;color:#333;'
                class="text-center sub_total_span  d-flex mt-1 py-1 justify-content-center align-items-center initial-balance-input width-full m-0 dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} ">
        ...
        <div class=" animate__animated animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            style="width: 100px;min-height: 60px">
            <label for="discount_type" class="mb-0 @if (app()->isLocale('ar')) d-block text-end mx-2 @else  mx-2 @endif"
        ...
        <div @if (isset($items[$index]['discount_type'])) class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif
            ...
            <div
                class="d-flex width-full dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} ">
            ...
            <div class="custom-control custom-switch">
                <input type="checkbox" class="custom-control-input" name="discount_on_bonus_quantity{{ $index }}"
                    id="discount_on_bonus_quantity_{{ $index }}"
                    wire:model="items.{{ $index }}.discount_on_bonus_quantity"
                    wire:change="changePurchasePrice({{ $index }},null,null,'discount')" style="font-size: 0.75rem"
                    value="true">
        ...
        {{-- <div
            class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <div class="d-flex flex-column width-full">
                ...
                <b class="dollar_price_after_discount width-full  p-0 d-flex justify-content-center align-items-center initial-balance-input width-full m-0 mt-1 dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                    style='font-weight:700;font-size:14px;color:#333;'>
        ...
        {{-- <div
            ...
            <label for="%" class="mb-0 @if (app()->isLocale('ar')) d-block text-end  mx-2  @else mx-2 @endif"
            ...
            <input type="text" class="form-control initial-balance-input width-full mx-0"
                wire:model="items.{{ $index }}.discount_percent" wire:change="purchase_final({{ $index }})"
                placeholder="%">
        </div> --}}
        ...
        <div class="accordion mr-1 mb-2 d-flex justify-content-center align-items-center"
            ...
            <div class="accordion-item" style="border: none">
                <h2 class="accordion-header">
                    <button class="accordion-button p-1 btn btn-primary collapsed" style="color: white" type="button"
                        data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse{{ $index }}discount-details"
                        data-index="{{ $index }}" aria-expanded="true"
        ...
        <div id="panelsStayOpen-collapse{{ $index }}discount-details"
            ...
            <div class="accordion-body p-0 d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                ...
                <div class="animate__animated  animate__bounceInLeft d-flex flex-column @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
                    ...
                    <input type="text" name="items.{{ $index }}.annual_discount" id="items.{{ $index }}.annual_discount"
                        class="form-control initial-balance-input width-full mx-0"
                        wire:model="items.{{ $index }}.annual_discount" wire:change="cost({{ $index }})"
                ...
                <div class=" animate__animated  animate__bounceInLeft d-flex flex-column @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
                    ...
                    <input type="text" name="items.{{ $index }}.seasonal_discount"
                        ...
                        class="form-control initial-balance-input width-full mx-0"
                        wire:model="items.{{ $index }}.seasonal_discount" wire:change="cost({{ $index }})"
                ...
                <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
                    ...
                    <input type="text" name="items.{{ $index }}.invoice_discount"
                        ...
                        class="form-control initial-balance-input width-full mx-0"
                        wire:model="items.{{ $index }}.invoice_discount" wire:change="cost({{ $index }})"
                        style="width: 100px;" placeholder="@lang('lang.invoice_discount')">

                    <input type="text" name="items.{{ $index }}.cash_discount" id="items.{{ $index }}.cash_discount"
                        class="form-control initial-balance-input width-full mx-0"
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" name="discount_dependency{{ $index }}"
                            id="discount_dependency_{{ $index }}" wire:model="items.{{ $index }}.discount_dependency"
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column align-items-center mr-1"
            ...
            <b style="font-weight: 700;color: #333"
                class="final_total_span d-flex justify-content-center align-items-center initial-balance-input width-full m-0 mt-1 dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                aria-placeholder="{{ __('lang.final purchase for piece') }}">
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column align-items-center mr-1"
            style="width: 150px;min-height: 60px">
            <label for="cost" class="mb-0 @if (app()->isLocale('ar')) d-block text-end  mx-2 @else mx-2 @endif"
            ...
            <b style="font-weight: 700;color: #333"
                class="dollar_cost d-flex justify-content-center align-items-center initial-balance-input width-full m-0 mt-1 dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                aria-placeholder="dollar cost">
                {{ $product['dollar_cost'] }} $
            </b>
        </div>
        ...
        <div class=" animate__animated  animate__bounceInLeft d-flex flex-column align-items-center mr-1"
            ...
            <span style="font-weight: 700;color: #333"
                class="final_total_span mt-1 d-flex justify-content-center align-items-center initial-balance-input width-full m-0 dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                aria-placeholder="final purchase">
    ...
    <div class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
        ...
        <div
            ...
            <div class="mb-2  animate__animated  animate__bounceInLeft d-flex flex-column @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
                ...
                <input type="text"
                    ...
                    wire:model="items.{{ $index }}.customer_prices.{{ $key }}.percent" maxlength="6" placeholder="%">
            </div>
            <div class="mb-2  animate__animated  animate__bounceInLeft d-flex flex-column @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
                style="width: 105px;min-height: 40px">
                <label class="@if (app()->isLocale('ar')) d-block text-end  mx-2 mb-0 @else mx-2 mb-0 @endif"
                    style='font-weight:500;font-size:10px;color:#333'>{{
                    $items[$index]['customer_prices'][$key]['customer_name'] }}</label>
                <input type="text"
                    class="form-control formatted_number mb-0 initial-balance-input width-full mx-0 dinar_sell_price"
                ...
                <span class="dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                    style='font-weight:500;font-size:10px;color:#888'>{{
                    $items[$index]['customer_prices'][$key]['dollar_increase'] }}
                    $</span>
            ...
            <div class="mb-2  animate__animated  animate__bounceInLeft d-flex flex-column @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
                ...
                <span class="dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                    style='font-weight:500;font-size:10px;color:#888'>{{
                    $items[$index]['customer_prices'][$key]['dollar_sell_price'] }}
                    $</span>
        ...
        <div style="min-width: 90px"
            ...
            <button class="accordion-button-out collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#panelsStayOpen-collapse{{ $index }}discount" data-index="{{ $index }}"
                aria-expanded="true" aria-controls="panelsStayOpen-collapse{{ $index }}discount"
        ...
        <div style="min-width: 90px"
            ...
            <button class="accordion-button-out collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#panelsStayOpen-collapse{{ $index }}validity" data-index="{{ $index }}"
                aria-expanded="true" aria-controls="panelsStayOpen-collapse{{ $index }}validity"
    ...
    <div class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
        ...
        <div class="animate__animated  animate__bounceInLeft d-flex flex-column store_drop_down  @if (app()->isLocale('ar')) align-items-end  @else align-items-start @endif mr-1 "
            ...
            <div class="input-wrapper justify-content-between" style="width: 100% !important">
                ...
                <button type="button"
                    class="add-button d-flex justify-content-center align-items-center createStoreModal"
                    data-toggle="modal" data-key="{{ $i }}" data-index="{{ $index }}" data-target="#createStoreModal">
                    <i class="fas fa-plus"></i>
                </button>
            </div>
        ...
        <div class="animate__animated  animate__bounceInLeft d-flex flex-column store_drop_down  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <div class="input-wrapper" style="width: 100%!important">
                <select name="items.{{ $index }}.stores.{{ $i }}.variation_id" class="form-select"
            ...
            <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
                style="width: 80px;min-height: 60px">
                <label class="mb-0 @if (app()->isLocale('ar')) d-block text-end  mx-2 @else mx-2 @endif"
                    style='font-weight:500;font-size:10px;color:#888'>{{ @number_format($unitValue,
                    num_of_digital_numbers()) }}</label>
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <span style='font-weight:500;font-size:10px;color:#888'
                ...
                $items[$index]['stores'][$i]['dollar_purchase_price'] ?? 0 }}$</span>
        ...
        !empty($store['dollar_purchase_price'])))
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column align-items-center mr-1"
            style="width: 150px;min-height: 60px">
            <label for="sub_total"
                class="@if (app()->isLocale('ar')) d-block text-end  mx-2 mb-0 @else mx-2 mb-0 @endif"
            ...
            <b style='font-weight:500;color:#333'
                class="sub_total_span d-flex justify-content-center align-items-center initial-balance-input width-full m-0 mt-1  dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} ">
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            style="width: 160px;min-height: 60px">
            <label for="%" class="mb-0 @if (app()->isLocale('ar')) d-block text-end  mx-2  @else mx-2 @endif"
                style='font-weight:500;font-size:10px;color:#888'>%</label>
            <div class="d-flex width-full">
                <input type="text" class="form-control initial-balance-input  p-0 px-2"
                    wire:model="items.{{ $index }}.stores.{{ $i }}.purchase_discount"
                    style='font-weight:500;font-size:10px;width: 100%!important'
                    wire:input="changePurchasePrice({{ $index }},'stores',{{ $i }})" placeholder="@lang('lang.amount')">
                {{-- <input type="text" class="form-control initial-balance-input width-full col-6 p-0 px-2"
                    wire:model="items.{{ $index }}.stores.{{ $i }}.purchase_discount_percent"
                    style='font-weight:500;font-size:10px;'
                    wire:input="changePurchasePrice({{ $index }},'stores',{{ $i }})" placeholder="%"> --}}

            </div>
            <div
                class="d-flex width-full dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} ">
                <span style='font-weight:500;font-size:10px;color:#888' class=" width-full col-6 p-0 ">
                    {{ @number_format($items[$index]['stores'][$i]['dollar_purchase_discount'],
                    num_of_digital_numbers()) }}
                    $</span>
                {{-- <span style='font-weight:500;font-size:10px;color:#888' class=" width-full col-6 p-0 ">
                    {{ @number_format($items[$index]['stores'][$i]['dollar_purchase_discount_percent'],
                    num_of_digital_numbers()) }}
                    $ </span> --}}
            </div>
            ...
            <div class="custom-control custom-switch">
                ...
                <input type="checkbox" class="custom-control-input"
                    name="discount_on_bonus_quantity{{ $index }}{{ $i }}" id="discount_on_bonus_quantity{{ $i }}"
                    wire:model="items.{{ $index }}.stores.{{ $i }}.discount_on_bonus_quantity"
                    wire:input="changePurchasePrice({{ $index }}, 'stores', {{ $i }})" style="font-size: 0.75rem"
                    value="true">
                <label class="custom-control-label"
        ...
        {{-- <div
            ...
            <div class="d-flex width-full flex-column">
                <b class="price_after_discount price_after_discount width-full  d-flex justify-content-center align-items-center initial-balance-input width-full m-0 p-0"
                    ...
                    {{ @number_format($items[$index]['stores'][$i]['purchase_after_discount'], num_of_digital_numbers())
                    ?? null }}
                </b>
                <b class="dollar_price_after_discount price_after_discount width-full  d-flex justify-content-center align-items-center initial-balance-input width-full m-0 mt-1 p-0 dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                    style='font-weight:500;color:#333'>
                    {{ @number_format($items[$index]['stores'][$i]['dollar_purchase_after_discount'],
                    num_of_digital_numbers()) ?? null }}
                </b>
            </div>
        </div> --}}
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <div class="d-flex  width-full">
                <input type="text" class="form-control   initial-balance-input width-full col-6 p-0 px-2"
                    ...
                    wire:input="purchase_final({{ $index }},'stores',{{ $i }})" placeholder="%">
                <input type="text" class="form-control   initial-balance-input width-full col-6 p-0 px-2"
                    style='font-weight:500;font-size:10px;' wire:model="items.{{ $index }}.stores.{{ $i }}.discount"
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <label for="purchase_price"
                ...
                style='font-weight:500;font-size:10px;color:#888'>@lang('lang.cash_discount')</label>
            <input type="text" class="form-control  initial-balance-input width-full mx-0"
                wire:model="items.{{ $index }}.stores.{{ $i }}.cash_discount" style="width: 100px;"
                wire:input="purchase_final({{ $index }},'stores',{{ $i }})" placeholder="@lang('lang.cash_discount')">
            <div class="custom-control custom-switch">
                <input type="checkbox" class="custom-control-input" name="discount_dependency{{ $index }}{{ $i }}"
                    id="discount_dependency{{ $i }}" wire:model="items.{{ $index }}.stores.{{ $i }}.discount_dependency"
                    wire:input="purchase_final({{ $index }},'stores',{{ $i }})" style="font-size: 0.75rem" value="true">
                <label class="custom-control-label"
        ...
        <div class="animate__animated  animate__bounceInLeft d-flex flex-column @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1 "
            ...
            <input type="text" class="form-control initial-balance-input width-full mx-0"
                ...
                wire:input="purchase_final({{ $index }},'stores',{{ $i }})" placeholder="@lang('lang.annual_discount')">
        </div>
        ...
        <div class="  animate__animated  animate__bounceInLeft d-flex flex-column align-items-center mr-1"
            ...
            <span
                ...
                style="font-weight:700;color: #333" aria-placeholder="{{ __('lang.final purchase for piece') }}">
                {{ $store['cost'] }}
            </span>
            <span
                class="cost_span  d-flex justify-content-center align-items-center initial-balance-input width-full m-0 mt-1 dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                style="font-weight:700;color: #333" aria-placeholder="{{ __('lang.final purchase for piece') }}">
                {{ $store['dollar_cost'] }} $
            </span>
        </div>
        ...
        <div
            ...
            <div class=" mb-2 animate__animated  animate__bounceInLeft d-flex flex-column @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
                ...
                <input type="text"
                    ...
                    id="percent{{ $i }}" name="items.{{ $index }}.stores.{{ $i }}.customer_prices.{{ $key }}.percent"
                    wire:model="items.{{ $index }}.stores.{{ $i }}.customer_prices.{{ $key }}.percent"
                    wire:input="changePercent({{ $index }},{{ $key }},'stores',{{ $i }})" maxlength="6" placeholder="%">
            </div>
            ...
            <div class="mb-2  animate__animated  animate__bounceInLeft d-flex flex-column justify-content-center @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
                ...
                <input type="text"
                    class="form-control formatted_number initial-balance-input width-full mx-0  dinar_sell_price"
                ...
                <span
                    class="dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} s"
                    style='font-weight:500;font-size:10px;color:#888'>{{
                    $items[$index]['stores'][$i]['customer_prices'][$key]['dollar_increase'] }}
                    $</span>
            ...
            <div class="mb-2  animate__animated  animate__bounceInLeft d-flex flex-column justify-content-center @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif mr-1"
                ...
                <span class="dollar-cell  showHideDollarCells  {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} "
                    style='font-weight:500;font-size:10px;color:#888'>{{
                    $items[$index]['stores'][$i]['customer_prices'][$key]['dollar_sell_price'] }}
                    $</span>
