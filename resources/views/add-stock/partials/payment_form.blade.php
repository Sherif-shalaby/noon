...
@if (isset($method) && $method != 'cash')
    <div
        class="col-md-3 mb-2  align-items-center  animate__animated animate__bounceInLeft @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif not_cash_fields {{ $show_payment == 1 ? 'd-none' : '' }}">
        <div
            class="d-flex width-full @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif align-items-center">
