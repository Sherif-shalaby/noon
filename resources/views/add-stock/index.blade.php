                            ...
                            <table id="example" class="table table-hover dataTable">
                                <thead>
                                    <tr style="position: sticky;
                                        ...
                                        <th class="dollar-cell showHideDollarCells col13">@lang('lang.product_discount')
                                        </th>
                                        <th class="dollar-cell showHideDollarCells col14">
                                            @lang('lang.product_discount_percent')</th>
                                        <th class="dollar-cell showHideDollarCells col15">@lang('lang.cash_discount')
                                        </th>
                                        <th class="dollar-cell showHideDollarCells col16">
                                            @lang('lang.seasonal_discount')</th>
                                        <th class="dollar-cell showHideDollarCells col17">@lang('lang.annual_discount')
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col13">
                                            <span
                                                ...
                                                @if (!empty($stock->add_stock_lines) && $stock->add_stock_lines->count()
                                                > 0)
                                                {{ $stock->add_stock_lines->where('used_currency', '!=',
                                                2)->sum('discount') }}
                                                <span>
                                                    {{ $stock->add_stock_lines->where('used_currency',
                                                    2)->sum('discount') }}</span>
                                        ...
                                        <td class="col14">
                                            <span
                                                class="custom-tooltip d-flex justify-content-center align-items-center dollar-cell showHideDollarCells"
                                                style="font-size: 12px;font-weight: 600"
                                                data-tooltip="@lang('lang.product_discount_percent')">
                                                @if (!empty($stock->add_stock_lines) && $stock->add_stock_lines->count()
                                                > 0)
                                                {{ $stock->add_stock_lines->where('used_currency', '!=',
                                                2)->sum('discount_percent') }}
                                                %
                                                <span>
                                                    {{ $stock->add_stock_lines->where('used_currency',
                                                    2)->sum('discount_percent') }}</span>
                                                $
                                                @else
                                                0
                                                @endif
                                        ...
                                        <td class="col16">
                                            <span
                                                ...
                                                > 0)
                                                {{ $stock->add_stock_lines->where('used_currency', '!=',
                                                2)->sum('seasonal_discount') }}
                                                %
                                                <span>
                                                    {{ $stock->add_stock_lines->where('used_currency',
                                                    2)->sum('seasonal_discount') }}</span>$
                                                @else
                                                0
                                                @endif
                                            </span>
                                        ...
                                        <td class="col17">
                                            <span
                                                ...
                                                > 0)
                                                {{ $stock->add_stock_lines->where('used_currency', '!=',
                                                2)->sum('annual_discount') }}
                                                %
                                                <span>
                                                    {{ $stock->add_stock_lines->where('used_currency',
                                                    2)->sum('annual_discount') }}</span>$
                                                @else
                                                0
                                                @endif
                                            </span>
