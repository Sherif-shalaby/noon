...
@if(isset($price))
    <tr>
        ...
        <td>
            {!! Form::select('price_customer_types_'.$row_id.'[]', $price_customer_types,  $price->price_customer_types , ['class' => 'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' => 'width: 80%', 'multiple', 'data-actions-box' => 'true', 'id' => 'price_customer_types']) !!}
        </td>
...
<tr>
    ...
    <td>
        {!! Form::select('price_customer_types_'.$row_id.'[]', $price_customer_types, !empty($price_product) ? $price_product->price_customer_types : false, ['class' => 'clear_input_form selectpicker form-control', 'data-live-search' => 'true', 'style' => 'width: 80%', 'multiple', 'data-actions-box' => 'true', 'id' => 'price_customer_types']) !!}
    </td>
    <td><button type="button" class="btn btn-xs btn-danger remove_row remove_price_btn"><i class="fa fa-times"></i></button></td>
