                                                ...
                                                @if (count($product->variations) > 0)
                                                    ...
                                                    @foreach ($product->variations as $index => $variation)
                                                        <div
                                                            ...
                                                            flex-wrap: nowrap;">
                                                                        <select
                                                                            name="products[0][variations][0][new_unit_id]"
                                                ...
                                                @else
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2 pt-4">
                                                            <button class="btn btn btn-warning add_small_unit"
                                                                type="button" data-key="0">
                                                                <i class="fa fa-equals"></i>
                                                            </button>
                                                        </div>
                                ...
                                <div class="accordion-item d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                                    ...
                                    <h2 class="accordion-header d-flex justify-content-end align-items-center">
                                        <div class="accordion-button"
                                            onclick="toggleProductAccordion(`productDimension`)">
                            ...
                            <div class="preview-image-container" tyle="display: flex !important;justify-content:center">
                                @if (!empty($product->image))
                                    <div class="preview">
                                        ...
                                        <span class="btn btn-xs btn-primary  crop-btn" id="crop-image-btn"
                                            data-toggle="modal" data-target="#imageModal"><i style="font-size: 25px;"
