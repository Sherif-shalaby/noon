    ...
    @if(isset($index) && $index!=='')
        ...
        <div class="col-md-2">
            ...
            <div class="d-flex justify-content-center">
                <select name="products[{{ $key }}][variations][{{$index}}][new_unit_id]"  data-name='unit_id' data-index="{{$index}}"  class="form-control unit_select select2 unit_id{{$index}}" style="width: 100px;" data-key="{{ $key }}">
