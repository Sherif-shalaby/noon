<div class="bn-group">
    <button type="button" class="btn btn-info btn-sm text-white mx-1" data-toggle="modal" data-target="#edit{{ $color->id }}"
        title="{{ __('Edit') }}">
...
{{-- modal edit --}}
<div class="modal fade" id="edit{{ $color->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="select_body d-flex justify-content-between align-items-center">
                            <input type="text" class="form-control" placeholder="@lang('colors.colorname')"
