    ...
    if (parentContainer.length) {
        ...
        if(childCount == basic_unit_variations_count){
            ...
            $('.add-store-data-btn[data-index="' + currentIndex + '"]').prop('disabled', false);
                ...
                // // Check the number of options for this select element
                // if (currentElement.find('option').length <= 2) {

                //     // Disable the button associated with this group
                // } else {

                //     // Enable the button if there are more than one options
                //     $('.add-store-data-btn[data-index="' + currentIndex + '"]').prop('disabled', false);
                // }
            });
        });
