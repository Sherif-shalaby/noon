...
<div class="row">
    <div class="col-md-12">
        <div class="card mt-3">
            ...
            {!! Form::open(['route' => 'initial-balance.store', 'method' => 'post', 'files' => true,'id' => 'add_stock_form']) !!}
            <div class="card-body">
                {{-- <div class="col-md-12"> --}}
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        {!! Form::select('status', ['received' =>  __('lang.received'), 'partially_received' => __('lang.partially_received')], !empty($recent_stock)&&!empty($recent_stock->status)?$recent_stock->status: 'Please Select', ['class' => 'select form-control select2', 'required',  'placeholder' => __('lang.please_select'),'wire:model' => 'status']) !!}
                        @error('status')
                        <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        {!! Form::select('divide_costs', ['size' =>  __('lang.size'), 'weight' => __('lang.weight'), 'price' => __('lang.price')], 'Please Select', ['class' => 'select2 form-control', 'data-live-search' => 'true', 'required',  'placeholder' => __('lang.please_select'), 'wire:model' => 'divide_costs']) !!}
                        @error('divide_costs')
                        <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-3 pt-4">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="change_current_stock" name="change_current_stock">
