            ...
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">@lang('lang.show_initial_balance')</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    {!! Form::label('store', __('lang.store'), []) !!}: <b>{{$add_stock->store->name .' ( '. $add_stock->store->branch->name.' ) '  ??
                                    ''}}</b>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <table class="table table-bordered table-striped table-condensed" id="product_table">
                                        ...
                                        @foreach ($add_stock->add_stock_lines as $line)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(isset($line->quantity)){{number_format($line->quantity,num_of_digital_numbers())}}@else{{1}}@endif
                                                </td>
                                                <td>
