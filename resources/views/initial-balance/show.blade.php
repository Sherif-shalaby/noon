                    ...
                    <div class="card-body">
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-4
                                ...
                                {!! Form::label('email', __('lang.email'), ['class' => 'mb-0']) !!}: <b>{{
                                    $add_stock->supplier->email ?? '' }}</b>
                            </div>
                            <div
                                class="col-md-4 d-flex mb-2 align-items-center  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif ">
                            ...
                            <div class="col-md-4
                                    d-flex mb-2 align-items-center
                                    @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                {!! Form::label('address', __('lang.address'), ['class' => 'mb-0']) !!}: <b>{{
                                    $add_stock->supplier->address ?? '' }}</b>
                            </div>
                            <div
                                class="col-md-4 d-flex mb-2 align-items-center  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif ">
                                {!! Form::label('store', __('lang.store'), ['class' => 'mb-0']) !!}:
                                <b>{{ $add_stock->store->name . ' ( ' . $add_stock->store->branch->name . ' ) ' ?? ''
                                    }}</b>
                            </div>
                            <div class="col-md-4
                                    d-flex mb-2 align-items-center
                            ...
                            <div class="col-md-4
                                    d-flex mb-2 align-items-center
                                    @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                {!! Form::label('store', __('lang.divide_costs'), ['class' => 'mb-0']) !!}: <b>{{
                                    $add_stock->divide_costs ?? '' }}</b>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="d-flex justify-content-center align-items-center"
                                                        ...
                                                        {{ number_format($line->quantity, num_of_digital_numbers())
                                                        }}@else{{ 1 }}
                                                        @endif
                                                    </span>
                                                </td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('notes', __('lang.notes'), ['class' => 'text-end d-block']) !!}:
                                    <br>
                                    {{ $add_stock->notes }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('files', __('lang.files'), ['class' => 'text-end d-block']) !!}:
                                    <br>
