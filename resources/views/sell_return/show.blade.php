        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        @lang('lang.date'): <b>{{@format_date($sale->transaction_date??0)}}</b>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        ...
                        <b>{{$return_parent->invoice_no??''}}</b>
                    </div>
                    <div class="col-md-12">
                        {!! Form::label('return_invoice_date', __('lang.return_invoice_date'), []) !!}:
                        <b>{{@format_date($return_parent->transaction_date??'')}}</b>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped table-condensed" id="product_table">
                        ...
                        <tbody>
                            ...
                            $total = 0;
                            @endphp
                            @if(!empty($return_parent->transaction_sell_lines))
                            @foreach ($return_parent->transaction_sell_lines as $line)
                ...
                <div class="col-md-6">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>{{($return_parent->final_total??0)}}</td>
                        </tr>
                        <tr>
                            <th>@lang('lang.paid_amount'):</th>
                            <td>{{($return_parent?->transaction_payments->sum('amount')??0)}}</td>
                        </tr>
                        <tr>
                            <th>@lang('lang.due'):</th>
                            <td> {{($return_parent->final_total??0 - $return_parent?->transaction_payments->sum('amount')??0)}}
                            </td>
                        </tr>
                    </table>
                </div>
