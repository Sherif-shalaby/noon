    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">@lang('lang.customer_balance_adjustment')</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/')}}">@lang('lang.dashboard')</a></li>
                        <li class="breadcrumb-item"><a href="{{route('customers.index')}}">@lang('lang.customers')</a></li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('lang.customer_balance_adjustment')</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        {!! Form::open(['url' => route('customer-balance-adjustment.store'), 'method' => 'post',
                        'id' =>
                        'sms_form', 'files' => true
                        ]) !!}
                        <div class="col-md-12">
...
{{--                                </div>--}}
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        select2', 'id' => 'user_id' ,'placeholder' =>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('customer_name', $customer->name , ['class' => 'form-control', 'id' => 'customer_name','readonly']) !!}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {!! Form::label('current_balance', __('lang.current_balance'), []) !!}
                                        {!! Form::text('current_balance', $customer->balance, ['class' => 'form-control', 'id' =>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('current_dollar_balance', $customer->dollar_balance, ['class' => 'form-control', 'id' =>
                                        'current_dollar_balance' ,'placeholder' =>
                                        __('lang.current_balance').' $', 'readonly']) !!}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {!! Form::label('add_new_balance', __('lang.add_new_balance').' $', []) !!}
                                        {!! Form::text('add_new_dollar_balance', null, ['class' => 'form-control', 'id' =>
                                        'add_new_dollar_balance' ,'placeholder' =>
                                        __('lang.add_new_balance')]) !!}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {!! Form::label('new_balance', __('lang.new_balance') .' $', []) !!}
                                        {!! Form::text('new_dollar_balance', null, ['class' => 'form-control', 'id' =>
                                        'new_dollar_balance' ,'placeholder' =>
                                        __('lang.new_balance')]) !!}
                                    </div>
                                </div>
                                <div class="col-md-12">
