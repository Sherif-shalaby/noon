                    ...
                    <form class="form" action="{{ route('suppliers.update', $supplier->id) }}" method="post"
                        ...
                        <div class="form-body">
                            <div class="row  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                ...
                                <div class="col-6 col-md-3 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                                    ...
                                    <div
                                        ...
                                        <input type="text" required class="form-control initial-balance-input m-auto"
                                            ...
                                            value="{{ $supplier->name }}">
                                        @error('name')
                                        <span style="font-size: 10px;font-weight: 700;" class="text-danger">{{ $message
                                            }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-md-3 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                                    ...
                                    <div
                                        ...
                                        <input type="text" class="form-control initial-balance-input m-auto"
                                            style="width: 100%" placeholder="@lang('lang.company_name')"
                                ...
                                <div class="col-6 col-md-3 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                                    ...
                                    <div
                                        ...
                                        <input type="date"
                                            ...
                                            style="border-color:#aaa" value="{{ $supplier->start_date }}">
                                        @error('start_date')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6 col-md-3 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                                    ...
                                    <div
                                        ...
                                        <input type="date"
                                            ...
                                            style="border-color:#aaa" value="{{ $supplier->end_date }}">
                                        @error('end_date')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6 col-md-3 dollar-cell showHideDollarCells mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                                    ...
                                    <div class="input-wrapper">
                                        <input type="number" class="form-control  initial-balance-input m-auto"
                                            ...
                                            id="owner_debt_in_dollar" value="{{ $supplier->owner_debt_in_dollar }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-md-3 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                                    ...
                                    <div
                                        ...
                                        <select id="state-dd" name="state_id" class="form-control select2">
                                            @php
                                            $states = \App\Models\State::where('country_id', $countryId)->get(['id',
                                            'name']);
                                            @endphp
                                                ...
                                                <tr>
                                                    <td class="col-md-12 p-0  mb-2">
                                                        <div class="select_body input-wrapper m-2 d-flex justify-content-between align-items-center"
                                                            ...
                                                            // Remove square brackets from each element in theemailArray
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                width="100%;" placeholder="@lang('lang.email')"
                                                                name="email[]"
                                                ...
                                                <td class="col-md-12 p-0 mb-2">
                                                    <div class="select_body input-wrapper d-flex justify-content-between align-items-center m-2"
                                                        ...
                                                        <input type="text" class=" initial-balance-input m-0"
                                                            ...
                                                            name="mobile_number[]" value="{{ $phone }}" required>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class=" initial-balance-input m-0" width="100%;"
                                                        style="flex-grow: 1" placeholder="@lang('lang.mobile_number')"
                                                        name="mobile_number[]" value="{{ $phone }}" required>
                                                    @error('mobile_number')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                        ...
                        <div class="col-6 col-md-3 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                            ...
                            <div class="input-wrapper">
                                ...
                                <input class="initial-balance-input m-auto form-control img"
                                    ...
                                    accept="image/*" value="{{ $supplier->image }}">
                            </div>
