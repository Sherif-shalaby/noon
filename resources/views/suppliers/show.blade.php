            ...
            <div class="col-md-12">
                <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (request()->show == 'statement_of_account') active @endif"
                            href="#statement-of-account" role="tab" data-toggle="tab">@lang('lang.statement_of_account')
                            @lang('lang.purchase')</a>
                    </li>
                    {{-- ++++++++++++ tab 4 : statement_of_account +++++++++++ --}}
                    <li class="nav-item">
                        <a class="nav-link @if (request()->show == 'statement_of_sell_account') active @endif"
                            href="#statement-of-sell-account" role="tab"
                            data-toggle="tab">@lang('lang.statement_of_account')
                            @lang('lang.sell')</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel"
                        ...
                        id="pending-orders">
                        <div class="wrapper1 @if (app()->isLocale('ar')) dir-rtl @endif" style="margin-top:40px ">
                            <div class="div1"></div>
                        </div>
                    ...
                    <div role="tabpanel"
                        class="tab-pane fade @if (request()->show == 'statement_of_sell_account') show active @endif"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sum dollar-cell showHideDollarCells">
                                                    @lang('lang.grand_total') $</th>
                                                <th class="sum dollar-cell showHideDollarCells">@lang('lang.paid') $
                                                </th>
                                                <th class="sum dollar-cell showHideDollarCells">@lang('lang.total_due')
                                                    $</th>
                                                <th>@lang('lang.status')</th>
                                                <th>@lang('lang.due_date')</th>
                                                {{-- <th>@lang('lang.action')</th> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        ...
                                                        {{ @num_format(-$line->final_total) }}@else{{
                                                        @num_format($line->final_total) }}
                                                        @endif
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span
                                                        ...
                                                        data-tooltip="@lang('lang.grand_total')">
                                                        @if ($line->type == 'sell_return')
                                                        {{ @num_format(-$line->dollar_final_total) }}@else{{
                                                        @num_format($line->dollar_final_total) }}
                                                        @endif
                                                    </span>
                                                </td>
