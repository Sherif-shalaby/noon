                                ...
                                <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                    ...
                                    <div
                                        ...
                                        <div class="input-wrapper">
                                            <input type="number" class="form-control initial-balance-input m-auto"
                                                style="width: 100%" name="owner_debt_in_dinar" id="owner_debt_in_dinar" />
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            <input type="number" class="form-control initial-balance-input m-auto"
                                                style="width: 100%" name="owner_debt_in_dollar" id="owner_debt_in_dollar" />
                                        </div>
                                    </div>
                                    {{-- ++++++++++++++++ countries selectbox +++++++++++++++++ --}}
                                    <div
                                        ...
                                        <div class="input-wrapper">
                                            <select id="country-dd" name="country" class=" initial-balance-input m-auto"
                                    ...
                                    <div
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            <select id="state-dd" name="state_id" class=" initial-balance-input m-auto"
                                    ...
                                    <div
                                        ...
                                        <div class="input-wrapper">
                                            <select id="city-dd" name="city_id" class=" initial-balance-input m-auto"
