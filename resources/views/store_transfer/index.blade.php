...
<li class="breadcrumb-item @if (app()->isLocale('ar')) mr-2 @else ml-2 @endif"><a
        style="text-decoration: none;color: #596fd7" href="{{ route('store_transfer.create') }}">/
        @lang('lang.store_transfer')</a>
</li>
...
<div class="widgetbar d-flex @if (app()->isLocale('ar')) justify-content-start @else justify-content-end @endif">
    <a type="button" class="btn btn-primary"
        href="{{ route('store_transfer.create') }}">@lang('lang.store_transfer')</a>
</div>
@endsection
                                ...
                                <table id="datatable-buttons" class="table  table-striped table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sum dollar-cell showHideDollarCells">
                                                @lang('lang.value_of_transaction') $</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>@if (!empty($transfer->approved_at))
                                                {{@format_date($transfer->approved_at)}} @endif</td> --}}
                                            {{-- <td>@if (!empty($transfer->received_at))
                                                {{@format_date($transfer->received_at)}} @endif</td> --}}
                                            <td>
                                                <span
                                                    class="custom-tooltip d-flex justify-content-center align-items-center"
                                                    style="font-size: 12px;font-weight: 600"
                                            ...
                                            {{-- <td> --}}
                                                {{-- <div class="btn-group"> --}}
                                                    {{-- <button type="button"
                                                        ...
                                                        {{-- </button> --}}
                                                    {{-- <ul
                                                        class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                        user="menu"> --}}
                                                        {{-- <li> --}}
                                                            {{-- <a
                                                                data-href="{{action('TransferController@show', $transfer->id)}}"
                                                        ...
                                                        {{-- <li> --}}
                                                            ...
                                                            {{-- <a
                                                                href="{{action('TransferController@print', $transfer->id)}}?print=true"
                                                        ...
                                                        {{-- <li> --}}
                                                            ...
                                                            {{-- <a
                                                                href="{{action('TransferController@edit', $transfer->id)}}"
                                                                class="btn"><i --}} {{--
                                                        ...
                                                        {{-- <li> --}}
                                                            {{-- <a
                                                                data-href="{{action('TransferController@destroy', $transfer->id)}}"
                                                                --}} {{--
