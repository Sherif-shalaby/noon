<tr>
    ...
    <td class="dollar-cell showHideDollarCells" title="{{ __('lang.purchase_price') }} $">
    ...
    {{-- <td title="{{__('lang.selling_price')}} $"> --}}
        ...
        {{-- @enderror --}}
        {{-- </td> --}}
    <td class="dollar-cell showHideDollarCells" title="{{ __('lang.sub_total') }} $">
        @if (!empty($product['quantity']) && (!empty($product['dollar_purchase_price']) ||
        !empty($product['purchase_price'])))
    ...
    <td title="{{ __('lang.purchase_price') }}">
        <input type="text" class="form-control" readonly wire:model="items.{{ $index }}.purchase_price"
    ...
    {{-- <td title="{{__('lang.selling_price')}}"> --}}
        {{-- <input type="text" class="form-control " readonly wire:model="items.{{ $index }}.selling_price"
            style="width: 61px;" required> --}}
