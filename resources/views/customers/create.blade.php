            ...
            <div class="card m-b-30 p-2">
                ...
                <div class="container-fluid">
                    <div class="row  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                        {{-- +++++++++++++++++++++++++++++++ customer_type ++++++++++++++++++++++++ --}}
                        {{-- <div
                            class=" col-6 col-md-3 flex-column col-md-3 mb-2 d-flex  align-items-end align-items-md-center @if (app()->isLocale('ar')) flex-md-row-reverse @else flex-md-row @endif animate__animated animate__bounceInLeft"
                        ...
                        +++++++++++++++++ --}}
                        <div class="mb-2 col-6 col-md-3 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                        ...
                        <div class="col-6 col-md-3 dollar-cell showHideDollarCells d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                        ...
                        <div class="mb-2 col-6 col-md-3 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                            ...
                            <div class="input-wrapper">
                                <select id="quarter-dd" class="form-control width-full select2"
                                        ...
                                        <td class="col-md-12 p-0 mb-2">
                                            <div class="select_body input-wrapper d-flex justify-content-between align-items-center m-2"
                                                ...
                                                <input type="text" class=" initial-balance-input m-0" width="100%;"
                                                    style="flex-grow: 1" placeholder="@lang('lang.email')"
                        ...
                        {{-- +++++++++++++++++++++++ address +++++++++++++++++++++++ --}}
                        <div class="col-6 col-md-6 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                            style="animation-delay: 1.85s">
                            {!! Form::label('address', __('lang.address'), [
                            'class' => app()->isLocale('ar') ? 'd-block text-end mx-2 mb-0' : 'mx-2 mb-0',
                            'style' => 'font-size: 12px;font-weight: 500;width:25%',
                            ]) !!}
                        ...
                        {{-- +++++++++++++++++++++++ Notes +++++++++++++++++++++++ --}}
                        <div class="col-6 col-md-6 mb-2 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                            style="animation-delay: 1.9s;min-height: 100px;">
                        ...
                        <div class="col-6 col-md-3 d-flex animate__animated animate__bounceInLeft flex-column py-0 px-1 @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
                            ...
                            <input class="form-control initial-balance-input width-full img" name="image" type="file"
                                accept="image/*" id="image">
                            {{-- Crop Image : cropper.js --}}
                            {{-- <div class="dropzone" id="my-dropzone2" required>
                                <div class="dz-message" data-dz-message>
                                    <span>@lang('categories.drop_file_here_to_upload')</span></div>
                            </div> --}}
                            @error('cover')
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <table class="table table-bordered  @if (app()->isLocale('ar')) dir-rtl @endif"
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 20%;">@lang('lang.important_date')
                                            </th>
                                            <th class="text-center" style="width: 20%;">@lang('lang.date')</th>
                                            <th class="text-center" style="width: 20%;">@lang('lang.notify_before_days')
                                            </th>
