<div class="row  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
    ...
    <div
        class="dollar-cell showHideDollarCells col-6 col-md-3 flex-column col-md-3 mb-2 d-flex @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif">
    ...
    <div
        ...
        <div class="input-wrapper width-full">
            <input type="number" class="form-control  m-0 initial-balance-input width-full " name="max_amount_in_dollar"
    ...
    <div class=" col-6 col-md-3 flex-column col-md-3 mb-2 d-flex @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif"
        ...
        <div class="input-wrapper width-full">
            ...
            {{-- <button type="button" class="btn btn-primary" data-toggle="modal" id="cities_id"
                data-target="#createRegionModal">
                    ...
                    <td class="col-md-12 p-0 mb-2">
                        <div class="select_body input-wrapper d-flex justify-content-between align-items-center m-2"
                            ...
                            <input type="text" class="form-control  initial-balance-input m-0" width="100%;"
                                style="flex-grow: 1" placeholder="@lang('lang.email')" name="email[]" value="" required>
                            @error('email')
