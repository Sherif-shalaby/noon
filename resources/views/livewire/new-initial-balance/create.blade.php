                                ...
                                <div class="accordion animate__animated  animate__bounceInLeft mb-2"
                                    ...
                                    <div class="accordion-item d-flex flex-column"
                                        ...
                                        <div
                                            ...
                                            <button type="button" class="plus-button py-2 my-1"
                                ...
                                @if ($this->isDiscountVisible)
                                    <div class="accordion animate__animated  animate__bounceInLeft mb-2">
                                        <div class="accordion-item d-flex flex-column"
                                            style=" background-color: transparent;border:none">
                                            <h2
                                                class="accordion-header p-0 d-flex justify-content-end align-items-center">
                                                <div class="accordion-button-down"
                                            ...
                                            <div
                                                class="d-flex flex-column  discount {{ $show_discount == 0 ? 'd-none' : '' }}">
