                ...
                <div class="card mt-1 mb-1">
                    ...
                    <div
                        ...
                        <div class="col-md-3 animate__animated animate__bounceInLeft" style="animation-delay: 1.1s">
                            <div class="i-checks">
                                <input id="clear_all_input_form" name="clear_all_input_form" type="checkbox" class=""
                        ...
                        <div class="d-flex justify-content-start align-items-center @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                            ...
                            <div class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                ...
                                <div class=" mb-2 align-items-center animate__animated animate__bounceInLeft  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif pl-1"
                                    ...
                                    'style' => 'width:100%;margin:0 !important;border:2px solid #ccc;font-size:
                                ...
                                <div class=" mb-2 align-items-center animate__animated animate__bounceInLeft  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif pl-1"
                                    ...
                                    <input type="text" name="name" value="{{ $item[0]['name'] }}"
                                        class="{{ app()->isLocale('ar') ? 'd-block text-end mx-2 mb-0 form-control required initial-balance-input' : 'd-block mx-2 mb-0 form-control required initial-balance-input' }}"
                                        style="width:100%;margin:0 !important;border:2px solid #ccc;font-size:12px;font-weight:500;"
                                        wire:model="item.0.name" placeholder="{{ __('lang.product_name') }}"
                                    ...
                                    : 'd-block mx-2 mb-0 form-control required initial-balance-input',
                                    'style' => 'width:100%;margin:0 !important;border:2px solid #ccc;font-size:
                                    12px;font-weight: 500;',
                                ...
                                <div class="mb-2 align-items-center animate__animated animate__bounceInLeft  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif pl-1"
                                    ...
                                    <input type="text" class="form-control initial-balance-input p-1" id="exchange_rate"
                                ...
                                <div class=" mb-2 animate__animated animate__bounceInLeft d-flex flex-column store  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif pl-1"
                                    ...
                                    <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede;
                                        ...
                                        'class' => ' form-control select2 all_stores store_id',
                                        'data-name' => 'store_id',
                                        'required',
                                ...
                                <div class="mb-2 align-items-center animate__animated animate__bounceInLeft  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif pl-1"
                                    ...
                                    <label for="invoice_currency"
                                        ...
                                        style='font-weight:500;font-size:10px;color:#888'>@lang('lang.currency')
                                        *</label>
                                    <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede;
                                            border: none;
                                        border-radius: 16px;
                                        ...
                                        height: 30px;
                                        flex-wrap: nowrap;">
                                        {!! Form::select('invoice_currency', $selected_currencies,
                                        $transaction_currency, [
                                        'class' => 'form-control invoice_currency select2',
                    ...
                    <div class="secondary_page">
                        <div
                            ...
                            <div class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                ...
                                <div class="mb-2 mx-2 align-items-end animate__animated animate__bounceInLeft  d-flex flex-column  px-1 {{ $show_category1 == 0 && $show_category3 == 0 && $show_category2 == 0 ? 'd-none' : '' }}"
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        flex-wrap: nowrap;
                                        ">
                                            {!! Form::select('subcategory_id1', $subcategories1,
                                            $item[0]['subcategory_id1'], [
                                ...
                                <div class="mb-2 mx-2 align-items-end animate__animated animate__bounceInLeft d-flex  flex-column  pl-1  {{ $show_category3 == 0 && $show_category2 == 0 ? 'd-none' : '' }}"
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        ">
                                            ...
                                            {!! Form::select('subcategory_id2', $subcategories2,
                                            $item[0]['subcategory_id2'], [
                                ...
                                <div class="mb-2 mx-2 align-items-end animate__animated animate__bounceInLeft d-flex  flex-column  pl-1 {{ $show_category3 == 0 ? 'd-none' : '' }}"
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        flex-wrap: nowrap;
                                        ">
                                            {!! Form::select('subcategory_id3', $subcategories3,
                                            $item[0]['subcategory_id3'], [
                                        ...
                                        <div class="accordion-body d-flex flex-row p-0">
                                            ...
                                            <div
                                                ...
                                                <label for="product"
                                                    ...
                                                    __('lang.product_tax') . '*' }}</label>
                                                <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede; border: none;
                                                        border-radius: 16px;
                                                        color: #373737;
                                                        box-shadow: 0 8px 6px -5px #bbb;
                                                        height: 30px;
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede; border: none;
                                                    ...
                                                    {!! Form::select(
                                                    'method',
                                                    ['inclusive' => __('lang.inclusive'), 'exclusive' =>
                                                    __('lang.exclusive')],
                                                    $item[0]['method'],
                                                    [
                                                    'id' => 'method',
                            ...
                            <div class="d-flex align-items-center">
                                <input type="file" wire:model="image" id="imageInput" class="d-none" />
                        ...
                        {{-- sizes --}}
                        <div class="accordion animate__animated  animate__bounceInLeft mb-2" style="">
                                            ...
                                            <div
                                                ...
                                                <div class=" mb-2  d-flex flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif px-1 extra_store_accordion"
                                                    ...
                                                    flex-wrap: nowrap;">
                                                        ...
                                                        'class' => 'form-control select2 all_stores extra_store_id',
                                                        'data-index' => $i,
                                                ...
                                                <div class="d-flex flex-row fill-stores-data-container">
                                                            ...
                                                            <div class=" mb-2 d-flex   flex-column  @if (app()->isLocale('ar')) align-items-end @else align-items-start @endif pl-1"
                                                                ...
                                                                <div class="d-flex justify-content-center align-items-center"
                                                                    style="background-color: #dedede;
                                                                        ...
                                                                        height: 30px;
                                                                        flex-wrap: nowrap;">
                                                                    {!! Form::select('store_fill_id',
                                                                    $basic_unit_variations,
                                                    ...
                                                    <div class=" mt-1  d-flex justify-content-center align-items-center px-1"
                                                        style="order: 1">
                                                        <button type="button"
                                                            class="plus-button add-store-data-btn mx-1 py-2"
                                                            data-index="{{ $i }}"
                                ...
                                <div class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif  dimensions {{ $show_dimensions == 0 ? 'd-none' : '' }}"
                                    ...
                                    <div
                                        ...
                                        <label for="basic_unit_variation_id"
                                            class="@if (app()->isLocale('ar')) d-block text-end  mx-2 mb-0 @else mx-2 mb-0 @endif"
                                            style='font-weight:500;font-size:10px;color:#888'>{{
                                            __('lang.basic_unit_for_import_product') . '*' }}</label>
                                        <div class="input-wrapper" style="width: 100%">

                                            {!! Form::select('basic_unit_variation_id', $basic_unit_variations,
                                            $item[0]['basic_unit_variation_id'], [
                                    ...
                                    <div
                                        ...
                                        <input type="text" wire:model='item.0.length' wire:change='changeSize()'
                                            ...
                                            style="border:2px solid #ccc;width: 75px;font-size:12px" placeholder={{
                                            __('lang.length') }} />
                                ...
                                <div class="d-flex flex-column  discount {{ $show_discount == 0 ? 'd-none' : '' }}">
                                    ...
                                    <div wire:key='{{ $key }}'
                                        ...
                                        <div class="mb-2  d-flex flex-column
                                            ...
                                            <label for="fill_id"
                                                class="@if (app()->isLocale('ar')) d-block text-end  mx-2 mb-0 @else mx-2 mb-0 @endif"
                                                style='font-weight:500;font-size:10px;color:#888'>{{ __('lang.fill')
                                                . '*' }}</label>
                                            <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede;
                                                border: none;
                                                    border-radius: 16px;
                                                    ...
                                                    height: 30px;
                                                    flex-wrap: nowrap;">
                                                {!! Form::select('prices.' . $key . '.fill_id',
                                                $basic_unit_variations, $prices[$key]['fill_id'], [
                                        ...
                                        <div class=" mb-2  d-flex flex-column
                                            ...
                                            <label class="text-danger validation-error error-msg">{{ $message
                                                }}</label>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="price_type  mb-2  d-flex flex-column
                                            ...
                                            <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede;
                                                ...
                                                ['fixed' => __('lang.fixed'), 'percentage' =>
                                                __('lang.percentage')],
                                                null,
                                                [
                                        ...
                                        <div
                                            ...
                                            <input type="text" name="prices.{{ $key }}.dinar_price" style="width: 100px"
...
<script>
    document.addEventListener('livewire:load', function () {
    Livewire.hook('message.processed', (message, component) => {
        document.querySelectorAll('.bonus_quantity').forEach(function (element) {
            if (element.value > 0) {
                element.closest('.discount_row').querySelectorAll('.price_type .custom-control .custom-control-input').forEach(function (input) {
...
// $(this).closest(".discount_row").find(".price_type").find('.custom-control').find(".custom-control-input").removeAttr("disabled");
// }
// });
