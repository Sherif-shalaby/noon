                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('sender_store_id', $stores, $sender_store_id, ['class' => ' form-control select2', 'data-live-search' => 'true', 'required', 'placeholder' => __('lang.please_select'),
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('receiver_store_id', $stores,null,
                                        ['class' => 'form-control select2','data-live-search' => 'true','wire:model' => 'receiver_store_id', 'id' => 'receiver_store_id', 'placeholder' => __('lang.please_select'),
...
{{--                                        <th style="width: 10%">@lang('lang.selling_price') </th>--}}
                        ...
                        <div class="col-md-12 text-center mt-1 ">
                            <h4>@lang('lang.items_count'):
                                <span class="items_count_span" style="margin-right: 15px;">{{ count($items) }}</span><br>
