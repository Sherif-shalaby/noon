            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header animate__animated animate__fadeInUp d-flex align-items-center @if (app()->isLocale('ar')) justify-content-end @else justify-content-start @endif"
                        ...
                        <h6 style="font-weight: 500">@lang('lang.add-stock')</h6>
                    </div>
                    <div
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                ...
                                <div
                                    ...
                                    <div class="col-md-2 pt-3">
                                        ...
                                        <h3
                                            class="dollar-cell showHideDollarCells {{ $dollar_expenses > 0 ? '' : 'd-none' }} {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <label
                                            ...
                                            style="margin-top: 25px;font-size: 12px;font-weight: 500;" for="due_amount"
                                            style="margin-top: 25px;">@lang('lang.duePaid'):
                                            <span class="due_amount_span">
                                                @if ($paying_currency == 2)
                                                <span
                                                    class="dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">{{
                                                    @number_format(@num_uf($this->sum_dollar_total_cost()) - $amount,
                                                    num_of_digital_numbers()) ?? '' }}</span>
                                                @else
                                ...
                                <div
                                    ...
                                    ['class' => 'form-control width-full initial-balance-input m-0', 'rows' => 3,
                                    'wire:model' => 'notes'],
                                    ) !!}
