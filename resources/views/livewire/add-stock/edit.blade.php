            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-md-12 pt-2 pb-2 {{ $supplier != null ? '' : 'd-none' }}">
                                    <div class="row">
                                        <div class="col-md-2 {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">
                                            @lang('lang.debit') {{ $supplier_data['dollar_debit'] }} $
                                        </div>
                                        <div class="col-md-2">@lang('lang.debit') {{ $supplier_data['dinar_debit'] }} د.ع
                                        </div>
                                        <div class="col-md-2">@lang('lang.email') {{ $supplier_data['email'][0] ?? '' }}
                                        </div>
                                        <div class="col-md-2">@lang('lang.phone') {{ $supplier_data['mobile'][0] ?? '' }}
                                        </div>
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 pt-3">
                                    ...
                                    <h3
                                        class="{{ $dollar_expenses > 0 ? '' : 'd-none' }} {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 m-t-15">
                                                    <div class="search-box input-group">
                                                        ...
                                                        <input type="search" name="search_product"
                                                            id="search_product"
                        ...
                        <div class="col-md-12">
                            <div class="col-md-3 offset-md-8 text-right">
                                <h3 class="{{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">
                                    @lang('lang.total')$ :
                                        ...
                                        <label for="due_amount" style="margin-top: 25px;">@lang('lang.duePaid'):
                                            <span class="due_amount_span">
                                                @if ($paying_currency == 2)
                                                    <span
                                                        class="{{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">{{ @number_format(@num_uf($this->sum_dollar_total_cost()) - $amount, num_of_digital_numbers()) ?? '' }}</span>
                                                @else
