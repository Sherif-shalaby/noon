                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="col-md-2 pt-3">
                                        ...
                                        <h3
                                            class="dollar-cell {{ $dollar_expenses > 0 ? '' : 'd-none' }} {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <label
                                                    ...
                                                    style="margin-top: 25px;font-size: 12px;font-weight: 500;"
                                                    for="due_amount" style="margin-top: 25px;">@lang('lang.duePaid'):
                                                    <span class="due_amount_span">
                                                        @if ($paying_currency == 2)
                                                            <span
                                                                class="dollar-cell {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">{{ @number_format(@num_uf($this->sum_dollar_total_cost()) - $amount, num_of_digital_numbers()) ?? '' }}</span>
                                                        @else
