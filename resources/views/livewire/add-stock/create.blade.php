                        ...
                        <div class="col-md-12">
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                ...
                                <div
                                    ...
                                    <div class="input-wrapper" style="width: 100%">
                                        {!! Form::select('purchase_type', ['import' => __('lang.import'), 'local' =>
                                        __('lang.local')], $purchase_type, [
                                        'class' => 'form-select',
                                        'required',
                                ...
                                <div
                                    ...
                                    <input type="text"
                                        class="form-control initial-balance-input width-full m-0 changeExchangerateForSupplier"
                                ...
                                <div
                                    ...
                                    <div class="input-wrapper" style="width: 100%">
                                        {!! Form::select(
                                        'divide_costs',
                                        ['size' => __('lang.size'), 'weight' => __('lang.weight'), 'price' =>
                                        __('lang.price')],
                                        $divide_costs,
                                        [
                                        'class' => 'form-control select2',
                            ...
                            <div class="col-md-12 pb-2 {{ $supplier != null ? '' : 'd-none' }}">
                                <div class="row  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                                    ...
                                    <div
                                        class="col-md-1 p-0 d-flex  border-left border-2 flex-column justify-content-start align-items-center dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} ">
                                        <span>
                                            @lang('lang.debit')
                                        </span>
                                        <span>
                                ...
                                <div class="table-responsive col-md-11 border border-1  animate__animated animate__bounceInLeft "
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span style="font-weight:700;font-size: 16px;">{{ $this->sum_size() ?? 0
                                                }}</span>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <span style="font-weight:700;font-size: 16px;">{{ $this->sum_weight() ?? 0
                                                }}</span>
                                        </div>

                                        <div>
                                            <span style="font-weight:700;font-size: 14px;"
                                                class="dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">$@lang('lang.total_cost')</span>
                                            <span style="font-weight:700;font-size: 16px;"
                                                class="dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}">{{
                                                $this->sum_dollar_total_cost() ?? 0 }}</span>
                                        </div>

                                        <div>
                                            <span
                                                style="font-weight:700;font-size: 14px;">@lang('lang.total_cost')</span>
                                            <span style="font-weight:700;font-size: 16px;">{{ $this->sum_total_cost() ??
                                                0 }}</span>
                                        </div> --}}
                                    </div>
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div
                                    ...
                                    <div class="col-md-2 mx-3">
                                        ...
                                        <h3
                                            class="dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }}  {{ $dollar_expenses > 0 ? '' : 'd-none' }}">
                                            @lang('lang.total_expenses')
                                            {{ @number_format($dollar_expenses, num_of_digital_numbers()) }} $</h3>
                                        <h3 class="{{ $dinar_expenses > 0 ? '' : 'd-none' }}">
                                            @lang('lang.total_expenses')
                                    ...
                                    <button
                                        ...
                                        style="height: 30px;animation-delay: 1.5s" wire:click="addExpense">{{
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="row flex-row-reverse align-items-center">
                                        <div
                                            ...
                                            <div class="input-wrapper width-full">
                                                {!! Form::select('expenses_currency', $selected_currencies,
                                        ...
                                        <div
                                            ...
                                            <button class="btn btn-danger btn-sm ml-2"
                                                wire:click="removeExpense({{ $index }})"><i class="fas fa-trash"></i>
                                            </button>
                                ...
                                <div
                                    ...
                                    'class' => app()->isLocale('ar') ? 'd-block text-end mx-2 mb-0 width-quarter' :
                                    'mx-2 mb-0 width-quarter',
                                    'style' => 'font-size: 12px;font-weight: 500;',
                                    ]) !!}
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="input-wrapper">
                                            {!! Form::select('source_type', ['pos' => __('lang.pos'), 'safe' =>
                                            __('lang.safe')], $source_type, [
                                            'class' => 'form-control select2',
                                            'data-live-search' => 'true',
                                            'placeholder' => __('lang.please_select'),
                                    ...
                                    <div
                                        ...
                                        <label for="due_amount"
                                            ...
                                            <span class="due_amount_span">
                                                ...
                                                <span
                                                    class="dollar-cell showHideDollarCells {{ $settings['toggle_dollar'] == '1' ? 'd-none' : '' }} ">
                                                    {{ @number_format(@num_uf($this->sum_dollar_total_cost()) - $amount,
                                                    num_of_digital_numbers()) ?? '' }}
                                                </span>
                                                @else
                                                {{ @number_format(@num_uf($this->sum_total_cost()) - $amount,
                                                num_of_digital_numbers()) ?? '' }}
                                                @endif
                                            </span>
                                        </label>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <input class="form-control m-0 initial-balance-input"
                                            placeholder="@lang('lang.due')" name="due_date" type="date" id="due_date"
                                            autocomplete="off" fdprocessedid="pipnea" wire:model="due_date">
                                    </div>
                                </div>
