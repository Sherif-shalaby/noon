        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    {!! Form::select('store_pos_id', $store_pos, null, [
                        'class' => 'select form-control',
                        'data-live-search' => 'true',
                        'required',
                        'placeholder' => __('lang.please_select'),
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    {!! Form::select('invoice_lang', $languages + ['ar_and_en' => 'Arabic and English'], null, [
                        'class' => 'form-control select',
                        'data-live-search' => 'true',
                        'placeholder' => __('lang.please_select'),
                        'wire:model' => 'invoice_lang',
                    ]) !!}
                    @error('invoice_lang')
                        <span class="error text-danger">{{ $message }}</span>
                    @enderror
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    {!! Form::select(
                        'payment_status',
                        ['pending' => __('lang.pending'), 'paid' => __('lang.paid'), 'partial' => __('lang.partial')],
                        null,
                        [
                            'class' => 'form-control select',
                            'data-live-search' => 'true',
                    ...
                    <div class="body-card-app content py-2 ">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="body-card-app">
                                <div
                                    class="table-responsive @if (app()->isLocale('ar')) dir-rtl @endif box-table ">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-1 " style="width: 80px">
                                                        ...
                                                        <input class="form-control p-1 text-center" style="width: 50px"
                                                            type="text" min="1"
                                                ...
                                                <td>
                                                    <input class="form-control p-1 text-center" style="width: 65px"
                                                        type="text" min="1"
                                                ...
                                                <td>
                                                    <select class="select discount_category "
                                                ...
                                                {{--                                                </td> --}}
                                                <td>
                                                    <span class="current_stock"> {{ $item['quantity_available'] }}
                                                    </span>
                                                </td>
