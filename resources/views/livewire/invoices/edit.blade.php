        ...
        <div>
            <div
                ...
                <div class="col-md-3 d-flex mb-2 align-items-center  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif animate__animated animate__bounceInLeft"
                    ...
                    <label class=" @if (app()->isLocale('ar')) d-block text-end @endif h5 mb-0"
                        style="font-size: 12px;font-weight: 500;" for="" class="text-primary">العملاء</label>
                    <div class="input-wrapper mx-2">
            ...
            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                ...
                <div class="col-md-2 animate__animated animate__bounceInLeft" style="animation-delay: 1.3s">
                    <div style="background-color: #E6E6E6;color: black;border-right: 16px;box-shadow: 5px 8px 4px -5px #bbb inset;"
                        ...
                        <div class="col-md-6 p-0 form-check-inline checkbox-dark d-flex">
                            <input type="checkbox" id="from_a_to_z" wire:model="from_a_to_z"
                                class="sorting_filter filterInput" name="customCheckboxInline2">
            ...
            <div
                class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif cards hide-print ">
                                                    ...
                                                    <td style="font-weight: 700;font-size: 10px;height: 50px;"
                                                        ...
                                                        <div style="height: 100%;max-width: 100%;"
                                                            ...
                                                            <input style="font-weight: 700;font-size: 10px;width: 65px"
                                                                ...
                                                                style="width: 60px" type="text" min="1"
