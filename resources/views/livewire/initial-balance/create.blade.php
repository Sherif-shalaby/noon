                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div class="col-md-3 d-flex mb-2 align-items-center @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif animate__animated animate__bounceInLeft"
                                    ...
                                    <div class="d-flex justify-content-center align-items-center " style="background-color: #dedede; border: none;
                                        ...
                                        {{-- <a data-href="{{ route('store.create') }}" data-container=".view_modal"
                                            ...
                                            onMouseOver="this.style.color='#F9C751'"
                                ...
                                <div class="col-md-3 animate__animated animate__bounceInLeft d-flex mb-2 align-items-center  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                                    ...
                                    <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede; border: none;
                                        ...
                                        <button type="button"
                                            class="add-button supplier-button d-flex justify-content-center align-items-center"
                                ...
                                <div class="col-md-3 animate__animated animate__bounceInLeft d-flex mb-2 align-items-center  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                                    ...
                                    @error('item.0.name')
                                    <label style="font-size: 10px;font-weight: 700;" class="text-danger error-msg">{{
                                        $message }}</label>
                                    @enderror
                                </div>
                                {{-- <div class="col-md-3">
                                ...
                                <div class="col-md-3 d-flex mb-2 align-items-center animate__animated animate__bounceInLeft  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                                    ...
                                    <div class="d-flex justify-content-center align-items-center" style="background-color: #dedede; border: none;
                                        ...
                                        <a data-href="{{ route('categories.sub_category_modal') }}"
                                            ...
                                            class="add-button btn-modal openCategoryModal d-flex justify-content-center align-items-center"
                                            onMouseOver="this.style.color='#F9C751'"
                                            onMouseOut="this.style.color='white'" data-toggle="modal"
                                            data-select_category="2"><i class="fas fa-plus"></i></a>
                                        {{-- <button type="button"
                                            class="btn btn-primary btn-sm ml-2  openCategoryModal" data-toggle="modal"
                                            data-target=".createSubCategoryModal" data-select_category="2"><i
                                            ...
                                            <div id="panelsStayOpen-collapseOne"
                                                ...
                                                <div class="accordion-body d-flex">
                                                    ...
                                                    <div
                                                        ...
                                                        <div style="background-color: #dedede; border: none;
                                                                border-radius: 16px;
                                                                color: #373737;
                                                                box-shadow: 0 8px 6px -5px #bbb;
                                                                width: 25%;
                                ...
                                <div>
                                    ...
                                    <div class="fw-bold text-centeranimate__animated animate__flipInY "
                                        ...
                                        <div class=" mx-3 dollar-cell showHideDollarCells">
                                            <span>
                                ...
                                <div
                                    class="col-md-12 text-center mt-1 d-flex justify-content-evenly align-items-center">
