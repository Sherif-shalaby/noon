            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mt-3">
                        ...
                        {!! Form::open(['url' => route('stocks.store'), 'method' => 'post', 'id' => 'add_stock_form', 'enctype' => 'multipart/form-data']) !!}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#add-selected-btn', function () {
                ...
                // // Add the product ID to the product_selected array
