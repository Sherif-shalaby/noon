                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(['url' => route('cash-register.store'), 'id' => 'cash-register-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    {!! Form::label('amount', __('lang.amount') . '$ :*') !!}
                                    {!! Form::text('dollar_amount', null, ['class' => 'form-control', 'placeholder' => __('lang.amount'), 'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
