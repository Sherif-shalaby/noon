            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        {!! Form::select('commission_customer_types[]', $customer_types, !empty($employee->commission_customer_types) ? $employee->commission_customer_types : null, ['class' => 'form-control salary_select select2', 'multiple','placehoder'=>__('lang.please_select'), 'data-actions-box' => 'true']) !!}
                        <br>
                        <br>
                        {!! Form::label('commission_stores', __('lang.stores') . ':', ['class' => 'text-muted']) !!}
                        {!! Form::select('commission_stores[]', $stores, !empty($employee->commission_stores) ? $employee->commission_stores : null, ['class' => 'form-control salary_select select2', 'multiple' ,'placehoder'=>__('lang.please_select'), 'data-actions-box' => 'true']) !!}
                        <br>
                        <br>
