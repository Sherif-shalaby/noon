<table class="table @if (app()->isLocale('ar')) dir-rtl @endif" id="permission_table">
    {{-- ====================== thead ====================== --}}
    <thead>
        <tr>
            {{-- ++++++++++++++ "وحدة" column ++++++++++++++ --}}
                        ...
                        <tr class="sub_module_permission_{{ $key_module }}">
                            ...
                            <td class="">
                                {!! Form::checkbox(
                                    ...
                                    1,
                                    !empty($job) && !empty($job->hasPermissionTo($view_permission)) ? true : false,
                                    [
                                        'class' => 'check_box check_box_view',
                                        'title' => __('lang.view'),
                                        'checked' => !empty($job) && !empty($job->hasPermissionTo($view_permission)),
                                    ],
                                ) !!}
                            ...
                            <td class="">
                                {!! Form::checkbox(
                                    ...
                                    1,
                                    !empty($job) && !empty($job->hasPermissionTo($create_permission)) ? true : false,
                                    [
                                        'class' => 'check_box check_box_create',
                                        'title' => __('lang.create'),
                                        'checked' => !empty($job) && !empty($job->hasPermissionTo($create_permission)),
                                    ],
                                ) !!}
                            </td>
                            <td class="">
                                {!! Form::checkbox(
                                    ...
                                    1,
                                    !empty($job) && !empty($job->hasPermissionTo($edit_permission)) ? true : false,
                                    [
                                        'class' => 'check_box check_box_edit',
                                        'title' => __('lang.edit'),
                                        'checked' => !empty($job) && !empty($job->hasPermissionTo($edit_permission)),
                                    ],
                                ) !!}
                            </td>
                            <td class="">
                                {!! Form::checkbox(
                                    ...
                                    1,
                                    !empty($job) && !empty($job->hasPermissionTo($delete_permission)) ? true : false,
                                    [
                                        'class' => 'check_box check_box_delete',
                                        'title' => __('lang.delete'),
                                        'checked' => !empty($job) && !empty($job->hasPermissionTo($delete_permission)),
                                    ],
                                ) !!}
                            </td>
                        </tr>
