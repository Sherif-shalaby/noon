                        ...
                        <tr class="sub_module_permission_{{ $key_module }}">
                            ...
                            <td class="">
                                {!! Form::checkbox(
                                    ...
                                    1,
                                    !empty($user) && !empty($user->hasPermissionTo($create_permission)) ? true : false,
                                    ['class' => 'check_box check_box_create', 'title' => __('lang.create')],
                                ) !!}
                            </td>
                            <td class="">
                                {!! Form::checkbox(
                                    ...
                                    1,
                                    !empty($user) && !empty($user->hasPermissionTo($edit_permission)) ? true : false,
                                    ['class' => 'check_box check_box_create', 'title' => __('lang.edit')],
                                ) !!}
                            </td>
                            <td class="">
                                {!! Form::checkbox(
