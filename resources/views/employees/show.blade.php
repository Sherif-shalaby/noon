            ...
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">@lang('lang.employee') {{$employee->employee_name}}</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="fname">@lang('lang.employee_name'): </label> {{$employee->employee_name ?? ''}}
                                    </div>
                                    <div class="col-sm-6">
