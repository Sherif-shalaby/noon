                ...
                <div class="container-fluid">
                    <div class="col-md-12">
                        <div
                            ...
                            <h3 class="d-flex @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                <div
                                    ...
                                    <div class="input-wrapper main-card width-full main-page-select">
                                        {!! Form::select('store_id', $stores, session('user.is_superadmin') ? null :
                                        key($stores), [
                                ...
                                <div
                                    ...
                                    <div class="input-wrapper main-card width-full">
                                        ...
                                        'class' => 'form-control initial-balance-input width-full mx-0 time_picker
                                        filter',
                                        'id' => 'start_time',
                                        ]) !!}
                                    </div>
                    ...
                    <div class="col-sm-2">
                        <div class="wrapper main-card count-title text-center">
                            <div class="icon d-flex justify-content-center align-items-center" style="width: 100%">
                                <img style="width: 30px" src="{{ asset('/images/main/icons8-warehouse-100.png') }}"
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col5">
                                        ...
                                        <span class="product_unit" data-variation_id="{{ $variation->id }}"
                                            ...
                                            <span class="unit_value">{{
                                                $product->product_stores->sum('quantity_available') }}</span></span>
                                        <br>
                                        @else
                                        <span class="product_unit" data-variation_id="{{ $variation->id }}"
                                            data-product_id="{{ $product->id }}">{{ $variation->unit->name ?? '' }}
                                    ...
                                    <td class="col11"><span class="text-primary">{{ $product->product_dimensions->size
                                            ?? 0 }}</span>
                                    </td>
