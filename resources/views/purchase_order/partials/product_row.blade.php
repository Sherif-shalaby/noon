<tr>
    ...
    <td>
        <input type="text" class="form-control dollar-cell" style="width: 61px;" required
    ...
    {{-- <td>
        @if (isset($product['quantity']) && (isset($product['dollar_purchasing_price']) || isset($product['purchase_price'])))
    ...
    <td>
        @if (isset($product['quantity']) && isset($product['dollar_purchasing_price']))
            <span class="dollar_total_cost dollar-cell">
                {{ $this->dollar_total_cost($index) }}
            </span>

            <input type="hidden" class="form-control dollar-cell" style="width: 61px;"
