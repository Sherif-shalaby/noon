...
<li class="breadcrumb-item @if (app()->isLocale('ar')) mr-2 @else ml-2 @endif active"><a
        style="text-decoration: none;color: #596fd7" href="{{ route('purchase_order.index') }}">/
        @lang('lang.show_purchase_order')</a>
</li>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col3">
                                                                <span
                                                                    ...
                                                                    {{ !empty($requiredProduct->employee_id) ?
                                                                    $requiredProduct->employee->employee_name : '' }}
                                                                </span>
                                                            </td>
                                                            {{-- +++++++++++++++++ order_date +++++++++++++++++ --}}
                                                            <td class="col4">
                                                                <span
                                                                    ...
                                                                    {{ !empty($requiredProduct->order_date) ?
                                                                    $requiredProduct->order_date : '' }}
                                                                </span>
                                                            </td>
                                                            {{-- +++++++++++++++++ product_id +++++++++++++++++ --}}
                                                            <td class="col5">
                                                                <span
                                                                    ...
                                                                    {{-- {{ !empty($requiredProduct->product_id) ?
                                                                    $requiredProduct->product->name : '' }} --}}
                                                                    {{ !empty($requiredProduct->product_id) &&
                                                                    !is_null($requiredProduct->product) ?
                                                                    $requiredProduct->product->name : '' }}
                                                                </span>
                                                            </td>
                                                            {{-- +++++++++++++++++ store_id +++++++++++++++++ --}}
                                                            <td class="col6">
                                                                <span
                                                                    ...
                                                                    {{ !empty($requiredProduct->store_id) ?
                                                                    $requiredProduct->stores->name : '' }}
                                                                </span>
                                                            </td>
                                                            {{-- +++++++++++++++++ status +++++++++++++++++ --}}
                                                            <td class="col7">
                                                                <span
                                                                    ...
                                                                    {{ !empty($requiredProduct->status) ?
                                                                    $requiredProduct->status : '' }}
                                                                </span>
                                                            </td>
                                                            {{-- +++++++++++++++++ supplier_id +++++++++++++++++ --}}
                                                            <td class="col8">
                                                                <span
                                                                    ...
                                                                    {{ !empty($requiredProduct->supplier_id) ?
                                                                    optional($requiredProduct->supplier)->name : '' }}
                                                                </span>
                                                            </td>
                                                            {{-- +++++++++++++++++ branch_id +++++++++++++++++ --}}
                                                            <td class="col9">
                                                                <span
                                                                    ...
                                                                    {{ !empty($requiredProduct->branch_id) ?
                                                                    $requiredProduct->branch->name : '' }}
                                                                </span>
                                                            </td>
                                                            {{-- +++++++++++++++++ purchase_price ,
                                                            ...
                                                            <td class="col10">
                                                                <span
                                                                    ...
                                                                    {{ !empty($requiredProduct->purchase_price) ?
                                                                    $requiredProduct->purchase_price : '' }}
                                                                </span>
                                                                <br />
                                                                {{-- dollar_purchase_price --}}
                                                                <span class="dollar-cell showHideDollarCells">
                                                                    ...
                                                                    {{ !empty($requiredProduct->dollar_purchase_price) ?
                                                                    $requiredProduct->dollar_purchase_price : '' }}
                                                                    $
                                                                </span>
                                                                </span>
                                                            </td>
