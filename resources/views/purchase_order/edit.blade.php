                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    $purchase_order->store_id, ['class' => 'select2 form-control',
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    $purchase_order->supplier_id, ['class' => 'select2 form-control',
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    $purchase_order->status, ['class' => 'select2 form-control',
                                    'data-live-search'=>"true", 'required',
                                    'style' =>'width: 80%' , 'placeholder' => __('lang.please_select')]) !!} --}}
                                    {!! Form::select('status', $status_array,
                                    $purchase_order->status, ['class' => 'select2 form-control',
